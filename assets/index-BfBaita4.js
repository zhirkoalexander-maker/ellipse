...
#define LOW_PRECISION`),t}function _g(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===Sh?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===Cu?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===jn&&(t="SHADOWMAP_TYPE_VSM"),t}function yg(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case ws:case As:t="ENVMAP_TYPE_CUBE";break;case yr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function xg(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case As:t="ENVMAP_MODE_REFRACTION";break}return t}function vg(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case ja:t="ENVMAP_BLENDING_MULTIPLY";break;case Qu:t="ENVMAP_BLENDING_MIX";break;case td:t="ENVMAP_BLENDING_ADD";break}return t}function Mg(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function bg(o,t,e,n){const i=o.getContext(),s=e.defines;let r=e.vertexShader,a=e.fragmentShader;const l=_g(e),c=yg(e),d=xg(e),h=vg(e),u=Mg(e),f=e.isWebGL2?"":lg(e),g=cg(e),_=hg(s),m=i.createProgram();let p,y,x=e.glslVersion?"#version "+e.glslVersion+`
