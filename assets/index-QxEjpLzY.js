...
void main() {
    ...
    `,document.body.appendChild(n),this.crashOverlay=n,n.querySelector("#crash-menu").addEventListener("click",()=>{this.onCrashAction?.("menu")}),n.querySelector("#crash-restart").addEventListener("click",()=>{this.onCrashAction?.("restart")})}updateExplosion(t){if(this.explosionMeshes.length>0)for(let e=this.explosionMeshes.length-1;e>=0;e--){const n=this.explosionMeshes[e],i=n._age+t;n._age=i;const s=n._life,o=i/s;if(o>=1){this.sceneMgr.scene.remove(n),n.geometry.dispose(),n.material.dispose(),this.explosionMeshes.splice(e,1);continue}const a=n._shockRing,l=a?1+o*60:1+o*6;n.scale.setScalar(l);const c=s<1?2:1;n.material.opacity=a?Math.max(0,.85*(1-o*1.5)):Math.max(0,.9*(1-o*c)),n.position.x+=n._vx*t,n.position.y+=n._vy*t,n.position.z+=n._vz*t}}explosionMeshes=[];spawnExplosion(t,e,n){const i=[16746496,16729088,16720384,16737792,13386752,16755200],s=new ft(new fe(.8,12,8),new ve({color:16755200,transparent:!0,opacity:1,blending:cn,depthWrite:!1}));s.position.set(t,e,n),s._life=.8,s._age=0,this.sceneMgr.scene.add(s),this.explosionMeshes.push(s);for(let o=0;o<8;o++){const a=1+Math.random()*1.5,l=new fe(a,8,6),c=new ve({color:i[o%i.length],transparent:!0,opacity:.9,blending:cn,depthWrite:!1}),d=new ft(l,c),h=o/8*Math.PI*2,u=Math.random()*Math.PI,f=.3;d.position.set(t+Math.sin(h)*Math.cos(u)*f,e+Math.sin(u)*f,n+Math.cos(h)*Math.cos(u)*f),d._life=1.5+Math.random()*.5,d._age=0,d._vx=Math.sin(h)*Math.cos(u)*(1+Math.random()*3),d._vy=Math.sin(u)*(1+Math.random()*3),d._vz=Math.cos(h)*Math.cos(u)*(1+Math.random()*3),this.sceneMgr.scene.add(d),this.explosionMeshes.push(d)}for(let o=0;o<4;o++){const a=1.5+Math.random()*2,l=new ve({color:4473924,transparent:!0,opacity:.4,blending:_i,depthWrite:!1}),c=new ft(new fe(a,6,6),l),d=o/4*Math.PI*2+Math.random()*.5;c.position.set(t+Math.cos(d)*.5,e+(Math.random()-.5)*.3,n+Math.sin(d)*.5),c._life=2+Math.random()*.5,c._age=0,c._vx=Math.cos(d)*(.5+Math.random()*1.5),c._vy=(Math.random()-.5)*1,c._vz=Math.sin(d)*(.5+Math.random()*1.5),this.sceneMgr.scene.add(c),this.explosionMeshes.push(c)}}spawnShockRing(t=16777215){const e=new L;this.rocketGroup.getWorldPosition(e),e.x*kt,e.y*kt,e.z*kt;const n=new Un(.1,.2,64),i=new ve({color:t,transparent:!0,opacity:.85,side:De,blending:cn,depthWrite:!1}),s=new ft(n,i);s.position.set(this.rocketGroup.position.x,this.rocketGroup.position.y,this.rocketGroup.position.z),s.quaternion.copy(this.rocketQuat),s.scale.setScalar(1),s._life=1.2,s._age=0,s._shockRing=!0,s._vx=0,s._vy=0,s._vz=0,this.sceneMgr.scene.add(s),this.explosionMeshes.push(s)}hasLandingLegs(){const t=e=>{for(const n of e)if(n.part.kind==="legs"||t(n.children))return!0;return!1};return t(this.rocket.assembly.roots)}positionFlameAtNozzle(){let t=1/0,e=-1/0;this.rocketGroup.traverse(i=>{if(i instanceof ft){if(this.gearMeshes.includes(i)||i===this.rocketShadow||i===this.reentryGlow||i===this.reentryGlowMesh)return;const s=new gn().setFromObject(i);s.min.y<t&&(t=s.min.y),s.max.y>e&&(e=s.max.y)}}),this.rocketBottomY=t===1/0?-.1:t;const n=t===1/0?-.1:t-.01;this.engineFlame.getMesh().position.set(0,n,0),this.engineFlame.getMesh().rotation.set(0,0,0)}dispose(){this.crashOverlay&&(this.crashOverlay.remove(),this.crashOverlay=null),this.sceneMgr.scene.remove(this.rocketGroup);for(const t of this.debris)this.sceneMgr.scene.remove(t.mesh);this.debris=[];for(const t of this.explosionMeshes)this.sceneMgr.scene.remove(t),t.geometry.dispose(),t.material.dispose();this.explosionMeshes=[],this.controls.dispose(),this.engineFlame.dispose(),this.groundSmoke.dispose(),this.hud.unmount(),this.sound.dispose()}}function ay(r,t,e){const n=r.mass,i=[...r.position],s=[...r.velocity],o=ke(t(r),1/n),a=s,c=va(r,Ke(i,ke(o,.5*e)),Ke(s,ke(a,.5*e))),d=ke(t(c),1/n),h=Ke(s,ke(o,.5*e)),f=va(r,Ke(i,ke(d,.5*e)),Ke(s,ke(h,.5*e))),g=ke(t(f),1/n),_=Ke(s,ke(d,.5*e)),p=va(r,Ke(i,ke(g,e)),Ke(s,ke(_,e))),x=ke(t(p),1/n),y=Ke(s,ke(g,e)),b=ke(Ke(Ke(o,ke(d,2)),Ke(ke(g,2),x)),e/6),C=ke(Ke(Ke(a,ke(h,2)),Ke(ke(_,2),y)),e/6);r.position=Ke(i,C),r.velocity=Ke(s,b)}function va(r,t,e){return{...r,position:t,velocity:e}}function Ke(r,t){return[r[0]+t[0],r[1]+t[1],r[2]+t[2]]}function ke(r,t){return[r[0]*t,r[1]*t,r[2]*t]}class ly{bodies=[];add(t){this.bodies.push(t)}bodyByName(t){return this.bodies.find(e=>e.name===t)}propagate(t,e){let n=t;for(;n>0;){const i=Math.min(e,n);this.step(i),n-=i}}step(t){for(const e of this.bodies){if(e.mass<=0)continue;const n=xu(e,this.bodies);ay(e,()=>n,t)}}}const ai=xn*yn;class ti extends cl{radius;visualRadius;mesh;constructor(t,e,n,i,s){super(t,e,n,i),this.radius=s,this.visualRadius=s*ai;const o=new fe(this.visualRadius,64,32),a=new be({color:8421504});this.mesh=new ft(o,a),this.mesh.position.set(n[0]*ai,n[1]*ai,n[2]*ai)}getTerrainHeightVisual(t,e,n){return 0}syncMesh(){this.mesh.position.set(this.position[0]*ai,this.position[1]*ai,this.position[2]*ai)}getSurfaceRadiusAt(t){const e=t[0]-this.position[0],n=t[1]-this.position[1],i=t[2]-this.position[2],s=Math.sqrt(e*e+n*n+i*i);if(s===0)return this.radius;const o=e/s,a=n/s,l=i/s,d=this.getTerrainHeightVisual(o,a,l)/ai;return this.radius+d}}const Ma=xn*yn,hh=64,li=(r,t,e)=>{const n=Math.sin(r*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},cy=(r,t,e)=>{const n=Math.floor(r),i=Math.floor(t),s=Math.floor(e),o=r-n,a=t-i,l=e-s,c=o*o*(3-2*o),d=a*a*(3-2*a),h=l*l*(3-2*l),u=li(n,i,s),f=li(n+1,i,s),g=li(n,i+1,s),_=li(n+1,i+1,s),m=li(n,i,s+1),p=li(n+1,i,s+1),x=li(n,i+1,s+1),y=li(n+1,i+1,s+1);return Di(Di(Di(u,f,c),Di(g,_,c),d),Di(Di(m,p,c),Di(x,y,c),d),h)},Kr=(r,t,e,n)=>{let i=0,s=1,o=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*cy(r*l,t*l,e*l),o+=s,s*=.5}return i/o},Di=(r,t,e)=>r+(t-r)*e;class hy extends ti{getTerrainHeightVisual(t,e,n){const i=Kr(t*10+500,e*10+600,n*10+700,4),s=Kr(t*40+100,e*40+200,n*40+300,3),o=i*.8+s*.2,a=this.visualRadius*.03;return o>.4?((o-.4)/.6)**2*a:-(.4-o)/.4*a*.12}constructor(t,e){super("mercury",1e25*5,t,e,244e4);const n=this.visualRadius,s=new Ki().load(ji("/textures/mercury.jpg"),h=>{h.colorSpace=se,h.anisotropy=4}),o=new fe(n,hh,hh),a=o.attributes.position,l=new L,c=n*.03;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const u=l.x/n,f=l.y/n,g=l.z/n,_=Kr(u*10+500,f*10+600,g*10+700,4),m=Kr(u*40+100,f*40+200,g*40+300,3),p=_*.8+m*.2;let x=0;p>.4?x=((p-.4)/.6)**2*c:x=-(.4-p)/.4*c*.12,l.setLength(n+x),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,o.computeVertexNormals();const d=new be({map:s,roughness:.9,metalness:0,color:16777215});this.mesh=new ft(o,d),this.mesh.position.set(t[0]*Ma,t[1]*Ma,t[2]*Ma)}}const uh=`
