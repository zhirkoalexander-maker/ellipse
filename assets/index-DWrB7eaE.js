...
`)}function hg(o){return[o.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(Ss).join(`
...
#define LOW_PRECISION`),t}function yg(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===Sh?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===Pu?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===jn&&(t="SHADOWMAP_TYPE_VSM"),t}function xg(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case As:case Rs:t="ENVMAP_TYPE_CUBE";break;case yr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function vg(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Rs:t="ENVMAP_MODE_REFRACTION";break}return t}function Mg(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case ja:t="ENVMAP_BLENDING_MULTIPLY";break;case td:t="ENVMAP_BLENDING_MIX";break;case ed:t="ENVMAP_BLENDING_ADD";break}return t}function bg(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Sg(o,t,e,n){const i=o.getContext(),s=e.defines;let r=e.vertexShader,a=e.fragmentShader;const l=yg(e),c=xg(e),d=vg(e),h=Mg(e),u=bg(e),f=e.isWebGL2?"":cg(e),m=hg(e),_=ug(s),g=i.createProgram();let p,y,x=e.glslVersion?"#version "+e.glslVersion+`
