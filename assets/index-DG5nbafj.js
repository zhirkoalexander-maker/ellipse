...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ei,depthTest:!1,depthWrite:!1})}function wc(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:hl(),fragmentShader:`
		...
		`,blending:Ei,depthTest:!1,depthWrite:!1})}function Ac(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:hl(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Pg(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===Ch?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===Gd?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===ti&&(t="SHADOWMAP_TYPE_VSM"),t}function Lg(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case Ds:case Us:t="ENVMAP_TYPE_CUBE";break;case Er:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Ig(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Us:t="ENVMAP_MODE_REFRACTION";break}return t}function Dg(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case nl:t="ENVMAP_BLENDING_MULTIPLY";break;case uu:t="ENVMAP_BLENDING_MIX";break;case fu:t="ENVMAP_BLENDING_ADD";break}return t}function Ug(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Ng(o,t,e,n){const i=o.getContext(),s=e.defines;let r=e.vertexShader,a=e.fragmentShader;const l=Pg(e),c=Lg(e),u=Ig(e),h=Dg(e),d=Ug(e),f=e.isWebGL2?"":Mg(e),y=bg(e),g=Sg(s),m=i.createProgram();let p,x,_=e.glslVersion?"#version "+e.glslVersion+`
`:"";e.isRawShaderMaterial?(p=["#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,g].filter(Ps).join(`
`),p.length>0&&(p+=`
`),x=[f,"#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,g].filter(Ps).join(`
`),x.length>0&&(x+=`
...
`;class is{group=new an;innerMesh;outerMesh;innerMat;outerMat;constructor(t,e=4491519,n=.7,i,s=16737826,r=3){const a=new Rt(e),l=new Rt(s),c=i??t*.08,u=new P(0,0,0),h=t*1.01,d=new ge(h,64,48);this.innerMat=new Nn({vertexShader:_h,fragmentShader:C_,uniforms:{uSunDir:{value:new P(0,1,0)},uPlanetCenter:{value:u},uInnerRadius:{value:t},uAtmHeight:{value:c},uRayleighCol:{value:a},uMieCol:{value:new Rt(.9,.9,1)},uDensity:{value:n},uTerminatorCol:{value:l},uGlowPower:{value:r}},transparent:!0,blending:fn,depthWrite:!1,side:Un}),this.innerMesh=new ct(d,this.innerMat),this.group.add(this.innerMesh);const f=t*1.06,y=new ge(f,48,32);this.outerMat=new Nn({vertexShader:_h,fragmentShader:P_,uniforms:{uSunDir:{value:new P(0,1,0)},uPlanetCenter:{value:u},uInnerRadius:{value:t},uDensity:{value:n*.5},uGlowPower:{value:r}},transparent:!0,blending:fn,depthWrite:!1,side:Un}),this.outerMesh=new ct(y,this.outerMat),this.group.add(this.outerMesh)}setSunDirection(t,e){const n=new P().copy(t).sub(e).normalize();this.innerMat.uniforms.uSunDir.value.copy(n),this.outerMat.uniforms.uSunDir.value.copy(n)}getMesh(){return this.group}dispose(){this.innerMat.dispose(),this.outerMat.dispose(),this.innerMesh.geometry.dispose(),this.outerMesh.geometry.dispose()}}const Ca=mn*gn,vh=64,mi=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},L_=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=mi(n,i,s),f=mi(n+1,i,s),y=mi(n,i+1,s),g=mi(n+1,i+1,s),m=mi(n,i,s+1),p=mi(n+1,i,s+1),x=mi(n,i+1,s+1),_=mi(n+1,i+1,s+1);return zi(zi(zi(d,f,c),zi(y,g,c),u),zi(zi(m,p,c),zi(x,_,c),u),h)},ar=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*L_(o*l,t*l,e*l),r+=s,s*=.5}return i/r},zi=(o,t,e)=>o+(t-o)*e;class I_ extends Xn{getTerrainHeightVisual(t,e,n){const i=ar(t*6+50,e*6+100,n*6+150,4),s=ar(t*15+200,e*15+300,n*15+400,3),r=i*.6+s*.4,a=this.visualRadius*.015;return r>.35?((r-.35)/.65)**2*a:-(.35-r)/.35*a*.05}atmosphereGlow;constructor(t,e){super("venus",146e23,t,e,6052e3);const n=this.visualRadius,s=new qs().load(Ys("/textures/venus.jpg"),h=>{h.colorSpace=se,h.anisotropy=4}),r=new ge(n,vh,vh),a=r.attributes.position,l=new P,c=n*.015;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const d=l.x/n,f=l.y/n,y=l.z/n,g=ar(d*6+50,f*6+100,y*6+150,4),m=ar(d*15+200,f*15+300,y*15+400,3),p=g*.6+m*.4;let x=0;p>.35?x=((p-.35)/.65)**2*c:x=-(.35-p)/.35*c*.05,l.setLength(n+x),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const u=new oe({map:s,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(r,u),this.mesh.position.set(t[0]*Ca,t[1]*Ca,t[2]*Ca),this.atmosphereGlow=new is(n,15247436,.4),this.mesh.add(this.atmosphereGlow.getMesh())}}const Pa=mn*gn;class D_ extends Xn{constructor(t,e){super("pluto",44e20,t,e,1188e3);const n=new ge(this.visualRadius,32,16),i=new oe({color:14535867,roughness:.9,metalness:0});this.mesh=new ct(n,i),this.mesh.position.set(t[0]*Pa,t[1]*Pa,t[2]*Pa)}}const La=mn*gn;function U_(o){let t=o|0;return()=>{t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function N_(){const e=document.createElement("canvas");e.width=2048,e.height=1024;const n=e.getContext("2d"),i=n.createImageData(2048,1024);for(let r=0;r<1024;r++)for(let a=0;a<2048;a++){const l=r/1024,c=a/2048,u=(l-.5)*Math.PI,h=c*Math.PI*2,d=Math.cos(u)*Math.cos(h),f=Math.cos(u)*Math.sin(h),y=Math.sin(u);let g=(Math.sin(d*3+f*1.3+y*.7)*.5+.5)*.4+(Math.sin((d+1.7)*6+y*1.1)*.5+.5)*.3;g*=Math.max(0,1-Math.abs(l-.5)*1.2),g=Math.max(0,Math.min(255,(g-.4)*2.5*255));const m=(r*2048+a)*4;i.data[m]=i.data[m+1]=i.data[m+2]=g,i.data[m+3]=255}n.putImageData(i,0,0);const s=new en(e);return s.wrapS=s.wrapT=Oe,s}function F_(){const e=document.createElement("canvas");e.width=1024,e.height=512;const n=e.getContext("2d");n.fillStyle="#000000",n.fillRect(0,0,1024,512);const i=U_(42),s=[{lat:.7,lon:-1.8,rx:.5,ry:.8},{lat:-.4,lon:-1.3,rx:.6,ry:.35},{lat:.1,lon:.6,rx:.55,ry:.4},{lat:.5,lon:1.5,rx:.6,ry:.4},{lat:.85,lon:.4,rx:.25,ry:.3}];for(const a of s){const l=(a.lon+Math.PI)/(2*Math.PI)*1024,c=(Math.PI/2-a.lat)/Math.PI*512,u=a.rx/(2*Math.PI)*1024,h=a.ry/Math.PI*512;for(let d=0;d<30;d++){const f=(i()-.5)*u*2,y=(i()-.5)*h*2;if((f/u)**2+(y/h)**2>1)continue;const g=120+Math.floor(i()*135);n.fillStyle=`rgb(${g},${Math.floor(g*.85)},${Math.floor(g*.5)})`,n.beginPath(),n.arc(l+f,c+y,1+i()*3,0,Math.PI*2),n.fill()}}const r=new en(e);return r.wrapS=r.wrapT=Oe,r.colorSpace=se,r}class k_ extends Xn{atmosphereGlow;cloudMesh;constructor(t,e){super("earth",Lx,t,e,6371e3*2);const n=this.visualRadius,i=320,s=new ge(n,i,i),r=s.attributes.position,a=new P,l=[],c=n*.035,u=n*.007;for(let g=0;g<r.count;g++){a.fromBufferAttribute(r,g);const m=a.x/n,p=a.y/n,x=a.z/n,_=this.terrainAt(m,p,x,c,u);a.setLength(n+_),r.setXYZ(g,a.x,a.y,a.z);const b=Math.max(-1,Math.min(1,_/c));let R,A,S;b<-.6?(R=.005,A=.04,S=.22):b<-.15?(R=.02,A=.1,S=.38):b<.02?(R=.5,A=.46,S=.28):b<.22?(R=.12,A=.35,S=.08):b<.5?(R=.18,A=.25,S=.08):b<.78?(R=.35,A=.3,S=.2):(R=.92,A=.88,S=.85),l.push(R,A,S)}r.needsUpdate=!0,s.setAttribute("color",new Ee(l,3)),s.computeVertexNormals();const h=new oe({roughness:.85,metalness:.05,vertexColors:!0,emissiveMap:F_(),emissive:new Rt(16768358),emissiveIntensity:.3});this.mesh=new ct(s,h),this.mesh.position.set(t[0]*La,t[1]*La,t[2]*La),this.loadTexture().catch(()=>{}),this.atmosphereGlow=new is(n,4491519,2.5,n*.1),this.mesh.add(this.atmosphereGlow.getMesh());const d=N_(),f=new oe({map:d,transparent:!0,opacity:.3,depthWrite:!1,side:ke,roughness:1,metalness:0}),y=new ge(n*1.008,64,32);this.cloudMesh=new ct(y,f),this.cloudMesh.position.copy(this.mesh.position),this.mesh.add(this.cloudMesh)}terrainAt(t,e,n,i,s){const r=Math.sin(t*5+e*3.5)*.5+Math.cos(e*4.5-n*3)*.3,a=Math.sin(n*7+t*3+e*5)*.2+Math.sin(t*13+e*9+n*11)*.12,l=Math.sin(t*20+n*16)*.06+Math.cos(e*18+t*13)*.04,c=Math.sin(t*38+e*33+n*42)*.02,u=((r+a+l+c)*.35+.5)*1.05;if(u>.48){const h=(u-.48)/.52;return h*h*i}return u>.38?(u-.38)/.1*i*.2:-(.38-u)/.38*s}async loadTexture(){try{const t=await new qs().loadAsync(Ys("/textures/earth_daymap.jpg"));t.colorSpace=se,this.mesh.material.map=t,this.mesh.material.needsUpdate=!0}catch{}}updateClouds(t,e){if(this.cloudMesh.rotation.y+=t*.01,e){const n=this.mesh.material,i=Math.sqrt(e[0]**2+e[1]**2+e[2]**2)||1;this.mesh.lookAt(this.mesh.position.x+e[0]/i*100,this.mesh.position.y+e[1]/i*100,this.mesh.position.z+e[2]/i*100),n.emissiveIntensity=.15}}}const Ia=mn*gn,Mh=64,gi=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},O_=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=gi(n,i,s),f=gi(n+1,i,s),y=gi(n,i+1,s),g=gi(n+1,i+1,s),m=gi(n,i,s+1),p=gi(n+1,i,s+1),x=gi(n,i+1,s+1),_=gi(n+1,i+1,s+1);return Gi(Gi(Gi(d,f,c),Gi(y,g,c),u),Gi(Gi(m,p,c),Gi(x,_,c),u),h)},lr=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*O_(o*l,t*l,e*l),r+=s,s*=.5}return i/r},Gi=(o,t,e)=>o+(t-o)*e;class H_ extends Xn{getTerrainHeightVisual(t,e,n){const i=lr(t*8+100,e*8+200,n*8+300,4),s=lr(t*30+400,e*30+500,n*30+600,3),r=i*.7+s*.3,a=this.visualRadius*.04;return r>.45?((r-.45)/.55)**2*a:-(.45-r)/.45*a*.15}constructor(t,e){super("moon",22e22,t,e,1737e3);const n=this.visualRadius,s=new qs().load(Ys("/textures/moon.jpg"),h=>{h.colorSpace=se,h.anisotropy=4}),r=new ge(n,Mh,Mh),a=r.attributes.position,l=new P,c=n*.04;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const d=l.x/n,f=l.y/n,y=l.z/n,g=lr(d*8+100,f*8+200,y*8+300,4),m=lr(d*30+400,f*30+500,y*30+600,3),p=g*.7+m*.3;let x=0;p>.45?x=((p-.45)/.55)**2*c:x=-(.45-p)/.45*c*.15,l.setLength(n+x),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const u=new oe({map:s,roughness:.95,metalness:0,color:16777215});this.mesh=new ct(r,u),this.mesh.position.set(t[0]*Ia,t[1]*Ia,t[2]*Ia)}}const Da=mn*gn,bh=64,yi=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},B_=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=yi(n,i,s),f=yi(n+1,i,s),y=yi(n,i+1,s),g=yi(n+1,i+1,s),m=yi(n,i,s+1),p=yi(n+1,i,s+1),x=yi(n,i+1,s+1),_=yi(n+1,i+1,s+1);return Wi(Wi(Wi(d,f,c),Wi(y,g,c),u),Wi(Wi(m,p,c),Wi(x,_,c),u),h)},cr=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*B_(o*l,t*l,e*l),r+=s,s*=.5}return i/r},Wi=(o,t,e)=>o+(t-o)*e;class z_ extends Xn{getTerrainHeightVisual(t,e,n){const i=cr(t*4+10,e*4+20,n*4+30,5),s=cr(t*20+100,e*20+200,n*20+300,3),r=i*.7+s*.3,a=this.visualRadius*.035;return r>.4?((r-.4)/.6)**2*a:-(.4-r)/.4*a*.1}atmosphereGlow;constructor(t,e){super("mars",19e23,t,e,339e4);const n=this.visualRadius,s=new qs().load(Ys("/textures/mars.jpg"),h=>{h.colorSpace=se,h.anisotropy=4}),r=new ge(n,bh,bh),a=r.attributes.position,l=new P,c=n*.035;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const d=l.x/n,f=l.y/n,y=l.z/n,g=cr(d*4+10,f*4+20,y*4+30,5),m=cr(d*20+100,f*20+200,y*20+300,3),p=g*.7+m*.3;let x=0;p>.4?x=((p-.4)/.6)**2*c:x=-(.4-p)/.4*c*.1,l.setLength(n+x),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const u=new oe({map:s,roughness:.85,metalness:0,color:16777215});this.mesh=new ct(r,u),this.mesh.position.set(t[0]*Da,t[1]*Da,t[2]*Da),this.atmosphereGlow=new is(n,13920842,.25),this.mesh.add(this.atmosphereGlow.getMesh())}}function xi(o,t,e){const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)}function G_(o,t,e){const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=xi(n,i,s),f=xi(n+1,i,s),y=xi(n,i+1,s),g=xi(n+1,i+1,s),m=xi(n,i,s+1),p=xi(n+1,i,s+1),x=xi(n,i+1,s+1),_=xi(n+1,i+1,s+1);return Vi(Vi(Vi(d,f,c),Vi(y,g,c),u),Vi(Vi(m,p,c),Vi(x,_,c),u),h)}function Pi(o,t,e,n){let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*G_(o*l,t*l,e*l),r+=s,s*=.5}return i/r}function Vi(o,t,e){return o+(t-o)*e}const Ua=mn*gn,Sh=64;class W_ extends Xn{atmosphereGlow;constructor(t,e){super("jupiter",19e26,t,e,69911e3);const n=this.visualRadius,i=Bx(),s=new ge(n,Sh,Sh),r=s.attributes.position,a=new P,l=n*.02;for(let u=0;u<r.count;u++){a.fromBufferAttribute(r,u);const h=a.x/n,d=a.y/n,f=a.z/n,y=Pi(h*8+10,d*8+20,f*8+30,4),g=Pi(h*30+100,d*30+200,f*30+300,3),m=y*.7+g*.3;let p=0;m>.4?p=((m-.4)/.6)**2*l:p=-(.4-m)/.4*l*.1,a.setLength(n+p),r.setXYZ(u,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new oe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*Ua,t[1]*Ua,t[2]*Ua),this.mesh.rotation.z=3.1*Math.PI/180,this.atmosphereGlow=new is(n,13935988,.15),this.mesh.add(this.atmosphereGlow.getMesh())}}const Na=mn*gn;function V_(){const e=document.createElement("canvas");e.width=1024,e.height=64;const n=e.getContext("2d"),i=n.createLinearGradient(0,0,1024,0);i.addColorStop(0,"#8a7a5a"),i.addColorStop(.05,"#b8a888"),i.addColorStop(.12,"#d4c8a8"),i.addColorStop(.2,"#c0b898"),i.addColorStop(.35,"#e8ddd0"),i.addColorStop(.5,"#c0b090"),i.addColorStop(.65,"#d8ccb0"),i.addColorStop(.8,"#a89878"),i.addColorStop(.9,"#786858"),i.addColorStop(1,"#584838"),n.fillStyle=i,n.fillRect(0,0,1024,64);for(let r=0;r<8e3;r++){const a=Math.random()*1024,l=Math.random()*64,c=1+Math.random()*4,u=120+Math.random()*80;n.fillStyle=`rgba(${u},${u-20},${u-40},${.2+Math.random()*.4})`,n.beginPath(),n.arc(a,l,c,0,Math.PI*2),n.fill()}n.fillStyle="rgba(0,0,0,0.7)",n.fillRect(1024*.43,0,1024*.04,64),n.fillStyle="rgba(0,0,0,0.4)",n.fillRect(1024*.72,0,1024*.015,64),n.fillStyle="rgba(0,0,0,0.3)",n.fillRect(1024*.1,0,1024*.02,64),n.fillRect(1024*.17,0,1024*.01,64),n.fillRect(1024*.55,0,1024*.02,64),n.fillStyle="rgba(200,190,170,0.15)";for(let r=0;r<1024;r+=8)n.fillRect(r,0,2,64);const s=new en(e);return s.wrapS=Oe,s.wrapT=Oe,s.anisotropy=4,s}class X_ extends Xn{atmosphereGlow;constructor(t,e){super("saturn",5683e23,t,e,58232e3);const n=this.visualRadius,i=zx(),s=new ge(n,64,32),r=s.attributes.position,a=new P,l=n*.015;for(let p=0;p<r.count;p++){a.fromBufferAttribute(r,p);const x=a.x/n,_=a.y/n,b=a.z/n,R=Pi(x*8+10,_*8+20,b*8+30,4),A=Pi(x*30+100,_*30+200,b*30+300,3),S=R*.7+A*.3;let O=0;S>.4?O=((S-.4)/.6)**2*l:O=-(.4-S)/.4*l*.1,a.setLength(n+O),r.setXYZ(p,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new oe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*Na,t[1]*Na,t[2]*Na),this.mesh.rotation.z=26.7*Math.PI/180,this.atmosphereGlow=new is(n,16049313,.1),this.mesh.add(this.atmosphereGlow.getMesh());const u=V_(),h=new Ci(n*1.15,n*2.4,256),d=new Ae({map:u,side:ke,transparent:!0,opacity:.8,depthWrite:!1}),f=new ct(h,d);f.rotation.x=-Math.PI/2,f.rotation.z=26.7*Math.PI/180,this.mesh.add(f);const y=new Ci(n*2.4,n*2.8,128),g=new Ae({color:8943720,side:ke,transparent:!0,opacity:.15,depthWrite:!1}),m=new ct(y,g);m.rotation.x=-Math.PI/2,m.rotation.z=26.7*Math.PI/180,this.mesh.add(m)}}const Fa=mn*gn;class q_ extends Xn{atmosphereGlow;constructor(t,e){super("uranus",8681e22,t,e,25362e3);const n=this.visualRadius,i=Gx(),s=new ge(n,64,32),r=s.attributes.position,a=new P,l=n*.015;for(let f=0;f<r.count;f++){a.fromBufferAttribute(r,f);const y=a.x/n,g=a.y/n,m=a.z/n,p=Pi(y*6+10,g*6+20,m*6+30,4),x=Pi(y*25+400,g*25+500,m*25+600,3),_=p*.7+x*.3;let b=0;_>.4?b=((_-.4)/.6)**2*l:b=-(.4-_)/.4*l*.1,a.setLength(n+b),r.setXYZ(f,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new oe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*Fa,t[1]*Fa,t[2]*Fa),this.mesh.rotation.z=-97.8*Math.PI/180,this.atmosphereGlow=new is(n,5230824,.1),this.mesh.add(this.atmosphereGlow.getMesh());const u=new Ci(n*1.2,n*2.1,64),h=new Ae({color:11184844,side:ke,transparent:!0,opacity:.3}),d=new ct(u,h);d.rotation.x=-Math.PI/2,d.rotation.z=97.8*Math.PI/180,this.mesh.add(d)}}const ka=mn*gn;class Y_ extends Xn{atmosphereGlow;constructor(t,e){super("neptune",1024e23,t,e,24622e3);const n=this.visualRadius,i=Wx(),s=new ge(n,64,32),r=s.attributes.position,a=new P,l=n*.015;for(let u=0;u<r.count;u++){a.fromBufferAttribute(r,u);const h=a.x/n,d=a.y/n,f=a.z/n,y=Pi(h*6+10,d*6+20,f*6+30,4),g=Pi(h*25+100,d*25+200,f*25+300,3),m=y*.7+g*.3;let p=0;m>.4?p=((m-.4)/.6)**2*l:p=-(.4-m)/.4*l*.1,a.setLength(n+p),r.setXYZ(u,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new oe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*ka,t[1]*ka,t[2]*ka),this.mesh.rotation.z=28.3*Math.PI/180,this.atmosphereGlow=new is(n,4944093,.15),this.mesh.add(this.atmosphereGlow.getMesh())}}const As=mn*gn,$_=`
varying vec2 vUv;
void main() {
  vUv = uv;
