...
void main() {
    ...
    `,s.appendChild(r);const a=document.createElement("div");a.style.cssText="width:40px;height:1px;background:rgba(128,144,168,0.2);margin:20px auto;",s.appendChild(a);const l=document.createElement("div");l.textContent="SPACE FLIGHT SIMULATOR",l.style.cssText="font:400 10px/1 system-ui,-apple-system,sans-serif;color:rgba(128,144,168,0.3);letter-spacing:0.35em;",s.appendChild(l),i.appendChild(s);const c=[{label:"FLIGHT",action:this.onPlay,primary:!0},{label:"VEHICLE ASSEMBLY",action:this.onVab,primary:!1},{label:"SETTINGS",action:this.onSettings,primary:!1}],d=document.createElement("div");d.style.cssText="display:flex;flex-direction:column;gap:1px;width:260px;";for(const f of c){const g=document.createElement("button");g.textContent=f.label,g.style.cssText=`
      ...
      `,g.addEventListener("mouseenter",()=>{g.style.background="rgba(160,176,200,0.04)",g.style.color="#c0d0e0",g.style.borderColor="rgba(160,176,200,0.2)",g.style.paddingLeft="32px"}),g.addEventListener("mouseleave",()=>{g.style.background="transparent",g.style.color=f.primary?"#a0b0c8":"rgba(160,176,200,0.5)",g.style.borderColor=f.primary?"rgba(160,176,200,0.12)":"rgba(160,176,200,0.04)",g.style.paddingLeft="24px"}),g.addEventListener("click",f.action),d.appendChild(g)}i.appendChild(d);const h=document.createElement("button");h.textContent="CONTROLS",h.style.cssText=`
...
//# sourceMappingURL=index-qq-3cyEv.js.map
