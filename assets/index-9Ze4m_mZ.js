...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function xc(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:sl(),fragmentShader:`
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function vc(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:sl(),fragmentShader:`
...
`)}function xg(o,t){const e={},n=o.getProgramParameter(t,o.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=o.getActiveAttrib(t,i),r=s.name;let a=1;s.type===o.FLOAT_MAT2&&(a=2),s.type===o.FLOAT_MAT3&&(a=3),s.type===o.FLOAT_MAT4&&(a=4),e[r]={type:s.type,location:o.getAttribLocation(t,r),locationSize:a}}return e}function As(o){return o!==""}function Cc(o,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return o.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Pc(o,t){return o.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const vg=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ga(o){return o.replace(vg,bg)}const Mg=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function bg(o,t){let e=Kt[t];if(e===void 0){const n=Mg.get(t);if(n!==void 0)e=Kt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Ga(e)}const Sg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Lc(o){return o.replace(Sg,Tg)}function Tg(o,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Ic(o){let t="precision "+o.precision+` float;
precision `+o.precision+" int;";return o.precision==="highp"?t+=`
#define HIGH_PRECISION`:o.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:o.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function Eg(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===Eh?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===kd?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===Jn&&(t="SHADOWMAP_TYPE_VSM"),t}function wg(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case Ps:case Ls:t="ENVMAP_TYPE_CUBE";break;case vr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Ag(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Ls:t="ENVMAP_MODE_REFRACTION";break}return t}function Rg(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case ja:t="ENVMAP_BLENDING_MULTIPLY";break;case au:t="ENVMAP_BLENDING_MIX";break;case lu:t="ENVMAP_BLENDING_ADD";break}return t}function Cg(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Pg(o,t,e,n){const i=o.getContext(),s=e.defines;let r=e.vertexShader,a=e.fragmentShader;const l=Eg(e),c=wg(e),u=Ag(e),h=Rg(e),d=Cg(e),f=e.isWebGL2?"":gg(e),g=yg(e),y=_g(s),m=i.createProgram();let p,_,v=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `,this.root.appendChild(r);const a=(l,c,u)=>{const h=document.createElement("button");return h.className=`btn btn--${c} menu-btn`,h.textContent=l,h.style.cssText="margin: 6px; min-width: 220px; padding: 12px 24px; font-size: 14px;",h.addEventListener("click",u),h};if(this.root.appendChild(a("FLIGHT","primary",this.onPlay)),this.onContinue&&this.root.appendChild(a("CONTINUE","secondary",this.onContinue)),this.root.appendChild(a("VEHICLE ASSEMBLY","secondary",this.onVab)),this.root.appendChild(a("MISSIONS","ghost",()=>this.toggleMissions())),this.root.appendChild(a("SETTINGS","ghost",this.onSettings)),this.root.appendChild(a("GUIDE","ghost",()=>this.toggleHelp())),this.missions){const l=document.createElement("div");l.style.cssText="position:fixed;top:16px;right:16px;z-index:500;color:var(--accent-gold);font:600 12px/1 monospace;letter-spacing:0.1em;background:rgba(8,10,24,0.6);border:1px solid rgba(200,152,56,0.2);border-radius:12px;padding:6px 12px;pointer-events:none;",l.textContent=`★ ${this.missions.totalScore}`,this.root.appendChild(l),this.scoreEl=l,this.missions.onScore(c=>{this.scoreEl&&(this.scoreEl.textContent=`★ ${c}`)})}else this.scoreEl=document.createElement("div")}toggleMissions(){if(this.missionsOverlay){this.missionsOverlay.remove(),this.missionsOverlay=null;return}if(!this.missions)return;const t=document.createElement("div");t.className="guide-overlay",t.style.cssText="position:fixed;inset:0;z-index:600;display:flex;align-items:center;justify-content:center;background:rgba(6,8,20,0.9);";const e=document.createElement("div");e.className="guide-card",e.style.cssText="max-width:520px;max-height:80vh;overflow-y:auto;padding:28px;font-family:system-ui,sans-serif;color:#ddd;background:#0c1020;border:1px solid rgba(200,152,56,0.2);border-radius:8px;";const n=new Set(this.missions.getCompleted());let i=0,s=0;for(const l of hr)i+=l.reward;for(const l of hr)n.has(l.id)&&(s+=l.reward);e.innerHTML=`<div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:16px;">
      ...
      </div>`,t.appendChild(e);const n=e.querySelector("#save-name");n.focus();const i=()=>t.remove();e.querySelector("#save-cancel").addEventListener("click",i);const s=()=>{const r=n.value.trim()||`Rocket ${new Date().toLocaleDateString()}`;wd(r,this.assembly),ge.show(`Saved: "${r}"`),i()};e.querySelector("#save-ok").addEventListener("click",s),n.addEventListener("keydown",r=>{r.key==="Enter"&&s(),r.key==="Escape"&&i()})}showLoadDialog(){const t=Z_().filter(s=>s!=="ellipse_assembly_last"),e=this.makeOverlay(),n=document.createElement("div");n.className="guide-card",n.style.cssText="max-width:380px;max-height:60vh;padding:24px;font-family:system-ui,sans-serif;color:#ddd;background:#0c1020;border:1px solid rgba(68,136,204,0.2);border-radius:8px;display:flex;flex-direction:column;",n.innerHTML=`
...
`;class es{group=new rn;innerMesh;outerMesh;innerMat;outerMat;constructor(t,e=4491519,n=.7,i,s=16737826,r=3){const a=new Tt(e),l=new Tt(s),c=i??t*.08,u=new L(0,0,0),h=t*1.01,d=new pe(h,64,48);this.innerMat=new Nn({vertexShader:mh,fragmentShader:Sx,uniforms:{uSunDir:{value:new L(0,1,0)},uPlanetCenter:{value:u},uInnerRadius:{value:t},uAtmHeight:{value:c},uRayleighCol:{value:a},uMieCol:{value:new Tt(.9,.9,1)},uDensity:{value:n},uTerminatorCol:{value:l},uGlowPower:{value:r}},transparent:!0,blending:un,depthWrite:!1,side:Dn}),this.innerMesh=new ct(d,this.innerMat),this.group.add(this.innerMesh);const f=t*1.06,g=new pe(f,48,32);this.outerMat=new Nn({vertexShader:mh,fragmentShader:Tx,uniforms:{uSunDir:{value:new L(0,1,0)},uPlanetCenter:{value:u},uInnerRadius:{value:t},uDensity:{value:n*.5},uGlowPower:{value:r}},transparent:!0,blending:un,depthWrite:!1,side:Dn}),this.outerMesh=new ct(g,this.outerMat),this.group.add(this.outerMesh)}setSunDirection(t,e){const n=new L().copy(t).sub(e).normalize();this.innerMat.uniforms.uSunDir.value.copy(n),this.outerMat.uniforms.uSunDir.value.copy(n)}getMesh(){return this.group}dispose(){this.innerMat.dispose(),this.outerMat.dispose(),this.innerMesh.geometry.dispose(),this.outerMesh.geometry.dispose()}}const ba=mn*gn,gh=64,fi=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},Ex=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=fi(n,i,s),f=fi(n+1,i,s),g=fi(n,i+1,s),y=fi(n+1,i+1,s),m=fi(n,i,s+1),p=fi(n+1,i,s+1),_=fi(n,i+1,s+1),v=fi(n+1,i+1,s+1);return Fi(Fi(Fi(d,f,c),Fi(g,y,c),u),Fi(Fi(m,p,c),Fi(_,v,c),u),h)},nr=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*Ex(o*l,t*l,e*l),r+=s,s*=.5}return i/r},Fi=(o,t,e)=>o+(t-o)*e;class wx extends Vn{getTerrainHeightVisual(t,e,n){const i=nr(t*6+50,e*6+100,n*6+150,4),s=nr(t*15+200,e*15+300,n*15+400,3),r=i*.6+s*.4,a=this.visualRadius*.015;return r>.35?((r-.35)/.65)**2*a:-(.35-r)/.35*a*.05}atmosphereGlow;constructor(t,e){super("venus",146e23,t,e,6052e3);const n=this.visualRadius,s=new Ws().load(Vs("/textures/venus.jpg"),h=>{h.colorSpace=ne,h.anisotropy=4}),r=new pe(n,gh,gh),a=r.attributes.position,l=new L,c=n*.015;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const d=l.x/n,f=l.y/n,g=l.z/n,y=nr(d*6+50,f*6+100,g*6+150,4),m=nr(d*15+200,f*15+300,g*15+400,3),p=y*.6+m*.4;let _=0;p>.35?_=((p-.35)/.65)**2*c:_=-(.35-p)/.35*c*.05,l.setLength(n+_),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const u=new ie({map:s,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(r,u),this.mesh.position.set(t[0]*ba,t[1]*ba,t[2]*ba),this.atmosphereGlow=new es(n,15247436,.4),this.mesh.add(this.atmosphereGlow.getMesh())}}const Sa=mn*gn;class Ax extends Vn{constructor(t,e){super("pluto",44e20,t,e,1188e3);const n=new pe(this.visualRadius,32,16),i=new ie({color:14535867,roughness:.9,metalness:0});this.mesh=new ct(n,i),this.mesh.position.set(t[0]*Sa,t[1]*Sa,t[2]*Sa)}}const Ta=mn*gn;function Rx(o){let t=o|0;return()=>{t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function Cx(){const e=document.createElement("canvas");e.width=2048,e.height=1024;const n=e.getContext("2d"),i=n.createImageData(2048,1024);for(let r=0;r<1024;r++)for(let a=0;a<2048;a++){const l=r/1024,c=a/2048,u=(l-.5)*Math.PI,h=c*Math.PI*2,d=Math.cos(u)*Math.cos(h),f=Math.cos(u)*Math.sin(h),g=Math.sin(u);let y=(Math.sin(d*3+f*1.3+g*.7)*.5+.5)*.4+(Math.sin((d+1.7)*6+g*1.1)*.5+.5)*.3;y*=Math.max(0,1-Math.abs(l-.5)*1.2),y=Math.max(0,Math.min(255,(y-.4)*2.5*255));const m=(r*2048+a)*4;i.data[m]=i.data[m+1]=i.data[m+2]=y,i.data[m+3]=255}n.putImageData(i,0,0);const s=new nn(e);return s.wrapS=s.wrapT=ze,s}function Px(){const e=document.createElement("canvas");e.width=1024,e.height=512;const n=e.getContext("2d");n.fillStyle="#000000",n.fillRect(0,0,1024,512);const i=Rx(42),s=[{lat:.7,lon:-1.8,rx:.5,ry:.8},{lat:-.4,lon:-1.3,rx:.6,ry:.35},{lat:.1,lon:.6,rx:.55,ry:.4},{lat:.5,lon:1.5,rx:.6,ry:.4},{lat:.85,lon:.4,rx:.25,ry:.3}];for(const a of s){const l=(a.lon+Math.PI)/(2*Math.PI)*1024,c=(Math.PI/2-a.lat)/Math.PI*512,u=a.rx/(2*Math.PI)*1024,h=a.ry/Math.PI*512;for(let d=0;d<30;d++){const f=(i()-.5)*u*2,g=(i()-.5)*h*2;if((f/u)**2+(g/h)**2>1)continue;const y=120+Math.floor(i()*135);n.fillStyle=`rgb(${y},${Math.floor(y*.85)},${Math.floor(y*.5)})`,n.beginPath(),n.arc(l+f,c+g,1+i()*3,0,Math.PI*2),n.fill()}}const r=new nn(e);return r.wrapS=r.wrapT=ze,r.colorSpace=ne,r}class Lx extends Vn{atmosphereGlow;cloudMesh;constructor(t,e){super("earth",w_,t,e,6371e3*2);const n=this.visualRadius,i=320,s=new pe(n,i,i),r=s.attributes.position,a=new L,l=[],c=n*.035,u=n*.007;for(let y=0;y<r.count;y++){a.fromBufferAttribute(r,y);const m=a.x/n,p=a.y/n,_=a.z/n,v=this.terrainAt(m,p,_,c,u);a.setLength(n+v),r.setXYZ(y,a.x,a.y,a.z);const b=Math.max(-1,Math.min(1,v/c));let R,w,M;b<-.6?(R=.005,w=.04,M=.22):b<-.15?(R=.02,w=.1,M=.38):b<.02?(R=.5,w=.46,M=.28):b<.22?(R=.12,w=.35,M=.08):b<.5?(R=.18,w=.25,M=.08):b<.78?(R=.35,w=.3,M=.2):(R=.92,w=.88,M=.85),l.push(R,w,M)}r.needsUpdate=!0,s.setAttribute("color",new be(l,3)),s.computeVertexNormals();const h=new ie({roughness:.85,metalness:.05,vertexColors:!0,emissiveMap:Px(),emissive:new Tt(16768358),emissiveIntensity:.3});this.mesh=new ct(s,h),this.mesh.position.set(t[0]*Ta,t[1]*Ta,t[2]*Ta),this.loadTexture().catch(()=>{}),this.atmosphereGlow=new es(n,4491519,2.5,n*.1),this.mesh.add(this.atmosphereGlow.getMesh());const d=Cx(),f=new ie({map:d,transparent:!0,opacity:.3,depthWrite:!1,side:Be,roughness:1,metalness:0}),g=new pe(n*1.008,64,32);this.cloudMesh=new ct(g,f),this.cloudMesh.position.copy(this.mesh.position),this.mesh.add(this.cloudMesh)}terrainAt(t,e,n,i,s){const r=Math.sin(t*5+e*3.5)*.5+Math.cos(e*4.5-n*3)*.3,a=Math.sin(n*7+t*3+e*5)*.2+Math.sin(t*13+e*9+n*11)*.12,l=Math.sin(t*20+n*16)*.06+Math.cos(e*18+t*13)*.04,c=Math.sin(t*38+e*33+n*42)*.02,u=((r+a+l+c)*.35+.5)*1.05;if(u>.48){const h=(u-.48)/.52;return h*h*i}return u>.38?(u-.38)/.1*i*.2:-(.38-u)/.38*s}async loadTexture(){try{const t=await new Ws().loadAsync(Vs("/textures/earth_daymap.jpg"));t.colorSpace=ne,this.mesh.material.map=t,this.mesh.material.needsUpdate=!0}catch{}}updateClouds(t,e){if(this.cloudMesh.rotation.y+=t*.01,e){const n=this.mesh.material,i=Math.sqrt(e[0]**2+e[1]**2+e[2]**2)||1;this.mesh.lookAt(this.mesh.position.x+e[0]/i*100,this.mesh.position.y+e[1]/i*100,this.mesh.position.z+e[2]/i*100),n.emissiveIntensity=.15}}}const Ea=mn*gn,yh=64,pi=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},Ix=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=pi(n,i,s),f=pi(n+1,i,s),g=pi(n,i+1,s),y=pi(n+1,i+1,s),m=pi(n,i,s+1),p=pi(n+1,i,s+1),_=pi(n,i+1,s+1),v=pi(n+1,i+1,s+1);return ki(ki(ki(d,f,c),ki(g,y,c),u),ki(ki(m,p,c),ki(_,v,c),u),h)},ir=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*Ix(o*l,t*l,e*l),r+=s,s*=.5}return i/r},ki=(o,t,e)=>o+(t-o)*e;class Dx extends Vn{getTerrainHeightVisual(t,e,n){const i=ir(t*8+100,e*8+200,n*8+300,4),s=ir(t*30+400,e*30+500,n*30+600,3),r=i*.7+s*.3,a=this.visualRadius*.04;return r>.45?((r-.45)/.55)**2*a:-(.45-r)/.45*a*.15}constructor(t,e){super("moon",22e22,t,e,1737e3);const n=this.visualRadius,s=new Ws().load(Vs("/textures/moon.jpg"),h=>{h.colorSpace=ne,h.anisotropy=4}),r=new pe(n,yh,yh),a=r.attributes.position,l=new L,c=n*.04;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const d=l.x/n,f=l.y/n,g=l.z/n,y=ir(d*8+100,f*8+200,g*8+300,4),m=ir(d*30+400,f*30+500,g*30+600,3),p=y*.7+m*.3;let _=0;p>.45?_=((p-.45)/.55)**2*c:_=-(.45-p)/.45*c*.15,l.setLength(n+_),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const u=new ie({map:s,roughness:.95,metalness:0,color:16777215});this.mesh=new ct(r,u),this.mesh.position.set(t[0]*Ea,t[1]*Ea,t[2]*Ea)}}const wa=mn*gn,_h=64,mi=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},Ux=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=mi(n,i,s),f=mi(n+1,i,s),g=mi(n,i+1,s),y=mi(n+1,i+1,s),m=mi(n,i,s+1),p=mi(n+1,i,s+1),_=mi(n,i+1,s+1),v=mi(n+1,i+1,s+1);return Oi(Oi(Oi(d,f,c),Oi(g,y,c),u),Oi(Oi(m,p,c),Oi(_,v,c),u),h)},sr=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*Ux(o*l,t*l,e*l),r+=s,s*=.5}return i/r},Oi=(o,t,e)=>o+(t-o)*e;class Nx extends Vn{getTerrainHeightVisual(t,e,n){const i=sr(t*4+10,e*4+20,n*4+30,5),s=sr(t*20+100,e*20+200,n*20+300,3),r=i*.7+s*.3,a=this.visualRadius*.035;return r>.4?((r-.4)/.6)**2*a:-(.4-r)/.4*a*.1}atmosphereGlow;constructor(t,e){super("mars",19e23,t,e,339e4);const n=this.visualRadius,s=new Ws().load(Vs("/textures/mars.jpg"),h=>{h.colorSpace=ne,h.anisotropy=4}),r=new pe(n,_h,_h),a=r.attributes.position,l=new L,c=n*.035;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const d=l.x/n,f=l.y/n,g=l.z/n,y=sr(d*4+10,f*4+20,g*4+30,5),m=sr(d*20+100,f*20+200,g*20+300,3),p=y*.7+m*.3;let _=0;p>.4?_=((p-.4)/.6)**2*c:_=-(.4-p)/.4*c*.1,l.setLength(n+_),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const u=new ie({map:s,roughness:.85,metalness:0,color:16777215});this.mesh=new ct(r,u),this.mesh.position.set(t[0]*wa,t[1]*wa,t[2]*wa),this.atmosphereGlow=new es(n,13920842,.25),this.mesh.add(this.atmosphereGlow.getMesh())}}function gi(o,t,e){const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)}function Fx(o,t,e){const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=gi(n,i,s),f=gi(n+1,i,s),g=gi(n,i+1,s),y=gi(n+1,i+1,s),m=gi(n,i,s+1),p=gi(n+1,i,s+1),_=gi(n,i+1,s+1),v=gi(n+1,i+1,s+1);return Hi(Hi(Hi(d,f,c),Hi(g,y,c),u),Hi(Hi(m,p,c),Hi(_,v,c),u),h)}function wi(o,t,e,n){let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*Fx(o*l,t*l,e*l),r+=s,s*=.5}return i/r}function Hi(o,t,e){return o+(t-o)*e}const Aa=mn*gn,xh=64;class kx extends Vn{atmosphereGlow;constructor(t,e){super("jupiter",19e26,t,e,69911e3);const n=this.visualRadius,i=N_(),s=new pe(n,xh,xh),r=s.attributes.position,a=new L,l=n*.02;for(let u=0;u<r.count;u++){a.fromBufferAttribute(r,u);const h=a.x/n,d=a.y/n,f=a.z/n,g=wi(h*8+10,d*8+20,f*8+30,4),y=wi(h*30+100,d*30+200,f*30+300,3),m=g*.7+y*.3;let p=0;m>.4?p=((m-.4)/.6)**2*l:p=-(.4-m)/.4*l*.1,a.setLength(n+p),r.setXYZ(u,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new ie({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*Aa,t[1]*Aa,t[2]*Aa),this.mesh.rotation.z=3.1*Math.PI/180,this.atmosphereGlow=new es(n,13935988,.15),this.mesh.add(this.atmosphereGlow.getMesh())}}const Ra=mn*gn;function Ox(){const e=document.createElement("canvas");e.width=1024,e.height=64;const n=e.getContext("2d"),i=n.createLinearGradient(0,0,1024,0);i.addColorStop(0,"#8a7a5a"),i.addColorStop(.05,"#b8a888"),i.addColorStop(.12,"#d4c8a8"),i.addColorStop(.2,"#c0b898"),i.addColorStop(.35,"#e8ddd0"),i.addColorStop(.5,"#c0b090"),i.addColorStop(.65,"#d8ccb0"),i.addColorStop(.8,"#a89878"),i.addColorStop(.9,"#786858"),i.addColorStop(1,"#584838"),n.fillStyle=i,n.fillRect(0,0,1024,64);for(let r=0;r<8e3;r++){const a=Math.random()*1024,l=Math.random()*64,c=1+Math.random()*4,u=120+Math.random()*80;n.fillStyle=`rgba(${u},${u-20},${u-40},${.2+Math.random()*.4})`,n.beginPath(),n.arc(a,l,c,0,Math.PI*2),n.fill()}n.fillStyle="rgba(0,0,0,0.7)",n.fillRect(1024*.43,0,1024*.04,64),n.fillStyle="rgba(0,0,0,0.4)",n.fillRect(1024*.72,0,1024*.015,64),n.fillStyle="rgba(0,0,0,0.3)",n.fillRect(1024*.1,0,1024*.02,64),n.fillRect(1024*.17,0,1024*.01,64),n.fillRect(1024*.55,0,1024*.02,64),n.fillStyle="rgba(200,190,170,0.15)";for(let r=0;r<1024;r+=8)n.fillRect(r,0,2,64);const s=new nn(e);return s.wrapS=ze,s.wrapT=ze,s.anisotropy=4,s}class Hx extends Vn{atmosphereGlow;constructor(t,e){super("saturn",5683e23,t,e,58232e3);const n=this.visualRadius,i=F_(),s=new pe(n,64,32),r=s.attributes.position,a=new L,l=n*.015;for(let p=0;p<r.count;p++){a.fromBufferAttribute(r,p);const _=a.x/n,v=a.y/n,b=a.z/n,R=wi(_*8+10,v*8+20,b*8+30,4),w=wi(_*30+100,v*30+200,b*30+300,3),M=R*.7+w*.3;let O=0;M>.4?O=((M-.4)/.6)**2*l:O=-(.4-M)/.4*l*.1,a.setLength(n+O),r.setXYZ(p,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new ie({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*Ra,t[1]*Ra,t[2]*Ra),this.mesh.rotation.z=26.7*Math.PI/180,this.atmosphereGlow=new es(n,16049313,.1),this.mesh.add(this.atmosphereGlow.getMesh());const u=Ox(),h=new Ei(n*1.15,n*2.4,256),d=new Ae({map:u,side:Be,transparent:!0,opacity:.8,depthWrite:!1}),f=new ct(h,d);f.rotation.x=-Math.PI/2,f.rotation.z=26.7*Math.PI/180,this.mesh.add(f);const g=new Ei(n*2.4,n*2.8,128),y=new Ae({color:8943720,side:Be,transparent:!0,opacity:.15,depthWrite:!1}),m=new ct(g,y);m.rotation.x=-Math.PI/2,m.rotation.z=26.7*Math.PI/180,this.mesh.add(m)}}const Ca=mn*gn;class Bx extends Vn{atmosphereGlow;constructor(t,e){super("uranus",8681e22,t,e,25362e3);const n=this.visualRadius,i=k_(),s=new pe(n,64,32),r=s.attributes.position,a=new L,l=n*.015;for(let f=0;f<r.count;f++){a.fromBufferAttribute(r,f);const g=a.x/n,y=a.y/n,m=a.z/n,p=wi(g*6+10,y*6+20,m*6+30,4),_=wi(g*25+400,y*25+500,m*25+600,3),v=p*.7+_*.3;let b=0;v>.4?b=((v-.4)/.6)**2*l:b=-(.4-v)/.4*l*.1,a.setLength(n+b),r.setXYZ(f,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new ie({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*Ca,t[1]*Ca,t[2]*Ca),this.mesh.rotation.z=-97.8*Math.PI/180,this.atmosphereGlow=new es(n,5230824,.1),this.mesh.add(this.atmosphereGlow.getMesh());const u=new Ei(n*1.2,n*2.1,64),h=new Ae({color:11184844,side:Be,transparent:!0,opacity:.3}),d=new ct(u,h);d.rotation.x=-Math.PI/2,d.rotation.z=97.8*Math.PI/180,this.mesh.add(d)}}const Pa=mn*gn;class zx extends Vn{atmosphereGlow;constructor(t,e){super("neptune",1024e23,t,e,24622e3);const n=this.visualRadius,i=O_(),s=new pe(n,64,32),r=s.attributes.position,a=new L,l=n*.015;for(let u=0;u<r.count;u++){a.fromBufferAttribute(r,u);const h=a.x/n,d=a.y/n,f=a.z/n,g=wi(h*6+10,d*6+20,f*6+30,4),y=wi(h*25+100,d*25+200,f*25+300,3),m=g*.7+y*.3;let p=0;m>.4?p=((m-.4)/.6)**2*l:p=-(.4-m)/.4*l*.1,a.setLength(n+p),r.setXYZ(u,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new ie({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*Pa,t[1]*Pa,t[2]*Pa),this.mesh.rotation.z=28.3*Math.PI/180,this.atmosphereGlow=new es(n,4944093,.15),this.mesh.add(this.atmosphereGlow.getMesh())}}const Es=mn*gn,Gx=`
varying vec2 vUv;
void main() {
  vUv = uv;
