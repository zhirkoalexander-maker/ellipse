...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function wc(){return new Dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:hl(),fragmentShader:`
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function Ac(){return new Dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:hl(),fragmentShader:`
	...
	`}function m0(o){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===za||l===Ga,u=l===Is||l===Ds;if(c||u)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let h=t.get(a);return e===null&&(e=new Tc(o)),h=c?e.fromEquirectangular(a,h):e.fromCubemap(a,h),t.set(a,h),h.texture}else{if(t.has(a))return t.get(a).texture;{const h=a.image;if(c&&h&&h.height>0||u&&h&&i(h)){e===null&&(e=new Tc(o));const d=c?e.fromEquirectangular(a):e.fromCubemap(a);return t.set(a,d),a.addEventListener("dispose",s),d.texture}else return null}}}return a}function i(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function r(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:r}}function g0(o){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=o.getExtension("WEBGL_depth_texture")||o.getExtension("MOZ_WEBGL_depth_texture")||o.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=o.getExtension("EXT_texture_filter_anisotropic")||o.getExtension("MOZ_EXT_texture_filter_anisotropic")||o.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=o.getExtension("WEBGL_compressed_texture_s3tc")||o.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||o.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=o.getExtension("WEBGL_compressed_texture_pvrtc")||o.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=o.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(n){n.isWebGL2?(e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance")):(e("WEBGL_depth_texture"),e("OES_texture_float"),e("OES_texture_half_float"),e("OES_texture_half_float_linear"),e("OES_standard_derivatives"),e("OES_element_index_uint"),e("OES_vertex_array_object"),e("ANGLE_instanced_arrays")),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture")},get:function(n){const i=e(n);return i===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function y0(o,t,e,n){const i={},s=new WeakMap;function r(h){const d=h.target;d.index!==null&&t.remove(d.index);for(const y in d.attributes)t.remove(d.attributes[y]);for(const y in d.morphAttributes){const g=d.morphAttributes[y];for(let m=0,p=g.length;m<p;m++)t.remove(g[m])}d.removeEventListener("dispose",r),delete i[d.id];const f=s.get(d);f&&(t.remove(f),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(h,d){return i[d.id]===!0||(d.addEventListener("dispose",r),i[d.id]=!0,e.memory.geometries++),d}function l(h){const d=h.attributes;for(const y in d)t.update(d[y],o.ARRAY_BUFFER);const f=h.morphAttributes;for(const y in f){const g=f[y];for(let m=0,p=g.length;m<p;m++)t.update(g[m],o.ARRAY_BUFFER)}}function c(h){const d=[],f=h.index,y=h.attributes.position;let g=0;if(f!==null){const x=f.array;g=f.version;for(let _=0,b=x.length;_<b;_+=3){const R=x[_+0],A=x[_+1],S=x[_+2];d.push(R,A,A,S,S,R)}}else if(y!==void 0){const x=y.array;g=y.version;for(let _=0,b=x.length/3-1;_<b;_+=3){const R=_+0,A=_+1,S=_+2;d.push(R,A,A,S,S,R)}}else return;const m=new(Gh(d)?Kh:$h)(d,1);m.version=g;const p=s.get(h);p&&t.remove(p),s.set(h,m)}function u(h){const d=s.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&c(h)}else c(h);return s.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function x0(o,t,e,n){const i=n.isWebGL2;let s;function r(f){s=f}let a,l;function c(f){a=f.type,l=f.bytesPerElement}function u(f,y){o.drawElements(s,y,a,f*l),e.update(y,s,1)}function h(f,y,g){if(g===0)return;let m,p;if(i)m=o,p="drawElementsInstanced";else if(m=t.get("ANGLE_instanced_arrays"),p="drawElementsInstancedANGLE",m===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}m[p](s,y,a,f*l,g),e.update(y,s,g)}function d(f,y,g){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<g;p++)this.render(f[p]/l,y[p]);else{m.multiDrawElementsWEBGL(s,y,0,a,f,0,g);let p=0;for(let x=0;x<g;x++)p+=y[x];e.update(p,s,1)}}this.setMode=r,this.setIndex=c,this.render=u,this.renderInstances=h,this.renderMultiDraw=d}function _0(o){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,r,a){switch(e.calls++,r){case o.TRIANGLES:e.triangles+=a*(s/3);break;case o.LINES:e.lines+=a*(s/2);break;case o.LINE_STRIP:e.lines+=a*(s-1);break;case o.LINE_LOOP:e.lines+=a*s;break;case o.POINTS:e.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",r);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function v0(o,t){return o[0]-t[0]}function M0(o,t){return Math.abs(t[1])-Math.abs(o[1])}function b0(o,t,e){const n={},i=new Float32Array(8),s=new WeakMap,r=new Me,a=[];for(let c=0;c<8;c++)a[c]=[c,0];function l(c,u,h){const d=c.morphTargetInfluences;if(t.isWebGL2===!0){const y=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,g=y!==void 0?y.length:0;let m=s.get(u);if(m===void 0||m.count!==g){let z=function(){K.dispose(),s.delete(u),u.removeEventListener("dispose",z)};var f=z;m!==void 0&&m.texture.dispose();const _=u.morphAttributes.position!==void 0,b=u.morphAttributes.normal!==void 0,R=u.morphAttributes.color!==void 0,A=u.morphAttributes.position||[],S=u.morphAttributes.normal||[],O=u.morphAttributes.color||[];let M=0;_===!0&&(M=1),b===!0&&(M=2),R===!0&&(M=3);let v=u.attributes.position.count*M,F=1;v>t.maxTextureSize&&(F=Math.ceil(v/t.maxTextureSize),v=t.maxTextureSize);const k=new Float32Array(v*F*4*g),K=new Xh(k,v,F,g);K.type=ti,K.needsUpdate=!0;const L=M*4;for(let q=0;q<g;q++){const Z=A[q],J=S[q],Q=O[q],tt=v*F*4*q;for(let dt=0;dt<Z.count;dt++){const ut=dt*L;_===!0&&(r.fromBufferAttribute(Z,dt),k[tt+ut+0]=r.x,k[tt+ut+1]=r.y,k[tt+ut+2]=r.z,k[tt+ut+3]=0),b===!0&&(r.fromBufferAttribute(J,dt),k[tt+ut+4]=r.x,k[tt+ut+5]=r.y,k[tt+ut+6]=r.z,k[tt+ut+7]=0),R===!0&&(r.fromBufferAttribute(Q,dt),k[tt+ut+8]=r.x,k[tt+ut+9]=r.y,k[tt+ut+10]=r.z,k[tt+ut+11]=Q.itemSize===4?r.w:1)}}m={count:g,texture:K,size:new Vt(v,F)},s.set(u,m),u.addEventListener("dispose",z)}let p=0;for(let _=0;_<d.length;_++)p+=d[_];const x=u.morphTargetsRelative?1:1-p;h.getUniforms().setValue(o,"morphTargetBaseInfluence",x),h.getUniforms().setValue(o,"morphTargetInfluences",d),h.getUniforms().setValue(o,"morphTargetsTexture",m.texture,e),h.getUniforms().setValue(o,"morphTargetsTextureSize",m.size)}else{const y=d===void 0?0:d.length;let g=n[u.id];if(g===void 0||g.length!==y){g=[];for(let b=0;b<y;b++)g[b]=[b,0];n[u.id]=g}for(let b=0;b<y;b++){const R=g[b];R[0]=b,R[1]=d[b]}g.sort(M0);for(let b=0;b<8;b++)b<y&&g[b][1]?(a[b][0]=g[b][0],a[b][1]=g[b][1]):(a[b][0]=Number.MAX_SAFE_INTEGER,a[b][1]=0);a.sort(v0);const m=u.morphAttributes.position,p=u.morphAttributes.normal;let x=0;for(let b=0;b<8;b++){const R=a[b],A=R[0],S=R[1];A!==Number.MAX_SAFE_INTEGER&&S?(m&&u.getAttribute("morphTarget"+b)!==m[A]&&u.setAttribute("morphTarget"+b,m[A]),p&&u.getAttribute("morphNormal"+b)!==p[A]&&u.setAttribute("morphNormal"+b,p[A]),i[b]=S,x+=S):(m&&u.hasAttribute("morphTarget"+b)===!0&&u.deleteAttribute("morphTarget"+b),p&&u.hasAttribute("morphNormal"+b)===!0&&u.deleteAttribute("morphNormal"+b),i[b]=0)}const _=u.morphTargetsRelative?1:1-x;h.getUniforms().setValue(o,"morphTargetBaseInfluence",_),h.getUniforms().setValue(o,"morphTargetInfluences",i)}}return{update:l}}function S0(o,t,e,n){let i=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=t.get(l,u);if(i.get(h)!==c&&(t.update(h),i.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(e.update(l.instanceMatrix,o.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,o.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==c&&(d.update(),i.set(d,c))}return h}function r(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:r}}class td extends ze{constructor(t,e,n,i,s,r,a,l,c,u){if(u=u!==void 0?u:ji,u!==ji&&u!==Us)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===ji&&(n=_i),n===void 0&&u===Us&&(n=Ki),super(null,i,s,r,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:qe,this.minFilter=l!==void 0?l:qe,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const ed=new ze,nd=new td(1,1);nd.compareFunction=zh;const id=new Xh,sd=new af,od=new Jh,Rc=[],Cc=[],Pc=new Float32Array(16),Lc=new Float32Array(9),Ic=new Float32Array(4);function zs(o,t,e){const n=o[0];if(n<=0||n>0)return o;const i=t*e;let s=Rc[i];if(s===void 0&&(s=new Float32Array(i),Rc[i]=s),t!==0){n.toArray(s,0);for(let r=1,a=0;r!==t;++r)a+=e,o[r].toArray(s,a)}return s}function Ge(o,t){if(o.length!==t.length)return!1;for(let e=0,n=o.length;e<n;e++)if(o[e]!==t[e])return!1;return!0}function We(o,t){for(let e=0,n=t.length;e<n;e++)o[e]=t[e]}function Cr(o,t){let e=Cc[t];e===void 0&&(e=new Int32Array(t),Cc[t]=e);for(let n=0;n!==t;++n)e[n]=o.allocateTextureUnit();return e}function T0(o,t){const e=this.cache;e[0]!==t&&(o.uniform1f(this.addr,t),e[0]=t)}function E0(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(o.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ge(e,t))return;o.uniform2fv(this.addr,t),We(e,t)}}function w0(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(o.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(o.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Ge(e,t))return;o.uniform3fv(this.addr,t),We(e,t)}}function A0(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(o.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ge(e,t))return;o.uniform4fv(this.addr,t),We(e,t)}}function R0(o,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ge(e,t))return;o.uniformMatrix2fv(this.addr,!1,t),We(e,t)}else{if(Ge(e,n))return;Ic.set(n),o.uniformMatrix2fv(this.addr,!1,Ic),We(e,n)}}function C0(o,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ge(e,t))return;o.uniformMatrix3fv(this.addr,!1,t),We(e,t)}else{if(Ge(e,n))return;Lc.set(n),o.uniformMatrix3fv(this.addr,!1,Lc),We(e,n)}}function P0(o,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ge(e,t))return;o.uniformMatrix4fv(this.addr,!1,t),We(e,t)}else{if(Ge(e,n))return;Pc.set(n),o.uniformMatrix4fv(this.addr,!1,Pc),We(e,n)}}function L0(o,t){const e=this.cache;e[0]!==t&&(o.uniform1i(this.addr,t),e[0]=t)}function I0(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(o.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ge(e,t))return;o.uniform2iv(this.addr,t),We(e,t)}}function D0(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(o.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ge(e,t))return;o.uniform3iv(this.addr,t),We(e,t)}}function U0(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(o.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ge(e,t))return;o.uniform4iv(this.addr,t),We(e,t)}}function N0(o,t){const e=this.cache;e[0]!==t&&(o.uniform1ui(this.addr,t),e[0]=t)}function F0(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(o.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ge(e,t))return;o.uniform2uiv(this.addr,t),We(e,t)}}function k0(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(o.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ge(e,t))return;o.uniform3uiv(this.addr,t),We(e,t)}}function O0(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(o.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ge(e,t))return;o.uniform4uiv(this.addr,t),We(e,t)}}function H0(o,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i);const s=this.type===o.SAMPLER_2D_SHADOW?nd:ed;e.setTexture2D(t||s,i)}function B0(o,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||sd,i)}function z0(o,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||od,i)}function G0(o,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||id,i)}function W0(o){switch(o){case 5126:return T0;case 35664:return E0;case 35665:return w0;case 35666:return A0;case 35674:return R0;case 35675:return C0;case 35676:return P0;case 5124:case 35670:return L0;case 35667:case 35671:return I0;case 35668:case 35672:return D0;case 35669:case 35673:return U0;case 5125:return N0;case 36294:return F0;case 36295:return k0;case 36296:return O0;case 35678:case 36198:case 36298:case 36306:case 35682:return H0;case 35679:case 36299:case 36307:return B0;case 35680:case 36300:case 36308:case 36293:return z0;case 36289:case 36303:case 36311:case 36292:return G0}}function V0(o,t){o.uniform1fv(this.addr,t)}function X0(o,t){const e=zs(t,this.size,2);o.uniform2fv(this.addr,e)}function q0(o,t){const e=zs(t,this.size,3);o.uniform3fv(this.addr,e)}function Y0(o,t){const e=zs(t,this.size,4);o.uniform4fv(this.addr,e)}function $0(o,t){const e=zs(t,this.size,4);o.uniformMatrix2fv(this.addr,!1,e)}function K0(o,t){const e=zs(t,this.size,9);o.uniformMatrix3fv(this.addr,!1,e)}function j0(o,t){const e=zs(t,this.size,16);o.uniformMatrix4fv(this.addr,!1,e)}function Z0(o,t){o.uniform1iv(this.addr,t)}function J0(o,t){o.uniform2iv(this.addr,t)}function Q0(o,t){o.uniform3iv(this.addr,t)}function tg(o,t){o.uniform4iv(this.addr,t)}function eg(o,t){o.uniform1uiv(this.addr,t)}function ng(o,t){o.uniform2uiv(this.addr,t)}function ig(o,t){o.uniform3uiv(this.addr,t)}function sg(o,t){o.uniform4uiv(this.addr,t)}function og(o,t,e){const n=this.cache,i=t.length,s=Cr(e,i);Ge(n,s)||(o.uniform1iv(this.addr,s),We(n,s));for(let r=0;r!==i;++r)e.setTexture2D(t[r]||ed,s[r])}function rg(o,t,e){const n=this.cache,i=t.length,s=Cr(e,i);Ge(n,s)||(o.uniform1iv(this.addr,s),We(n,s));for(let r=0;r!==i;++r)e.setTexture3D(t[r]||sd,s[r])}function ag(o,t,e){const n=this.cache,i=t.length,s=Cr(e,i);Ge(n,s)||(o.uniform1iv(this.addr,s),We(n,s));for(let r=0;r!==i;++r)e.setTextureCube(t[r]||od,s[r])}function lg(o,t,e){const n=this.cache,i=t.length,s=Cr(e,i);Ge(n,s)||(o.uniform1iv(this.addr,s),We(n,s));for(let r=0;r!==i;++r)e.setTexture2DArray(t[r]||id,s[r])}function cg(o){switch(o){case 5126:return V0;case 35664:return X0;case 35665:return q0;case 35666:return Y0;case 35674:return $0;case 35675:return K0;case 35676:return j0;case 5124:case 35670:return Z0;case 35667:case 35671:return J0;case 35668:case 35672:return Q0;case 35669:case 35673:return tg;case 5125:return eg;case 36294:return ng;case 36295:return ig;case 36296:return sg;case 35678:case 36198:case 36298:case 36306:case 35682:return og;case 35679:case 36299:case 36307:return rg;case 35680:case 36300:case 36308:case 36293:return ag;case 36289:case 36303:case 36311:case 36292:return lg}}class hg{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=W0(e.type)}}class dg{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=cg(e.type)}}class ug{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,r=i.length;s!==r;++s){const a=i[s];a.setValue(t,e[a.id],n)}}}const la=/(\w+)(\])?(\[|\.)?/g;function Dc(o,t){o.seq.push(t),o.map[t.id]=t}function fg(o,t,e){const n=o.name,i=n.length;for(la.lastIndex=0;;){const s=la.exec(n),r=la.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&r+2===i){Dc(e,c===void 0?new hg(a,o,t):new dg(a,o,t));break}else{let h=e.map[a];h===void 0&&(h=new ug(a),Dc(e,h)),e=h}}}class mr{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=t.getActiveUniform(e,i),r=t.getUniformLocation(e,s.name);fg(s,r,this)}}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,r=e.length;s!==r;++s){const a=e[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const r=t[i];r.id in e&&n.push(r)}return n}}function Uc(o,t,e){const n=o.createShader(t);return o.shaderSource(n,e),o.compileShader(n),n}const pg=37297;let mg=0;function gg(o,t){const e=o.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let r=i;r<s;r++){const a=r+1;n.push(`${a===t?">":" "} ${a}: ${e[r]}`)}return n.join(`
`)}function yg(o){const t=pe.getPrimaries(pe.workingColorSpace),e=pe.getPrimaries(o);let n;switch(t===e?n="":t===Mr&&e===vr?n="LinearDisplayP3ToLinearSRGB":t===vr&&e===Mr&&(n="LinearSRGBToLinearDisplayP3"),o){case Ce:case wr:return[n,"LinearTransferOETF"];case se:case ol:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",o),[n,"LinearTransferOETF"]}}function Nc(o,t,e){const n=o.getShaderParameter(t,o.COMPILE_STATUS),i=o.getShaderInfoLog(t).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const r=parseInt(s[1]);return e.toUpperCase()+`

`+i+`

`+gg(o.getShaderSource(t),r)}else return i}function xg(o,t){const e=yg(t);return`vec4 ${o}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function _g(o,t){let e;switch(t){case fu:e="Linear";break;case pu:e="Reinhard";break;case mu:e="OptimizedCineon";break;case gu:e="ACESFilmic";break;case xu:e="AgX";break;case yu:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+o+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function vg(o){return[o.extensionDerivatives||o.envMapCubeUVHeight||o.bumpMap||o.normalMapTangentSpace||o.clearcoatNormalMap||o.flatShading||o.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(o.extensionFragDepth||o.logarithmicDepthBuffer)&&o.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",o.extensionDrawBuffers&&o.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(o.extensionShaderTextureLOD||o.envMap||o.transmission)&&o.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Cs).join(`
`)}function Mg(o){return[o.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(Cs).join(`
`)}function bg(o){const t=[];for(const e in o){const n=o[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Sg(o,t){const e={},n=o.getProgramParameter(t,o.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=o.getActiveAttrib(t,i),r=s.name;let a=1;s.type===o.FLOAT_MAT2&&(a=2),s.type===o.FLOAT_MAT3&&(a=3),s.type===o.FLOAT_MAT4&&(a=4),e[r]={type:s.type,location:o.getAttribLocation(t,r),locationSize:a}}return e}function Cs(o){return o!==""}function Fc(o,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return o.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function kc(o,t){return o.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Tg=/^[ \t]*#include +<([\w\d./]+)>/gm;function $a(o){return o.replace(Tg,wg)}const Eg=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function wg(o,t){let e=jt[t];if(e===void 0){const n=Eg.get(t);if(n!==void 0)e=jt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return $a(e)}const Ag=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Oc(o){return o.replace(Ag,Rg)}function Rg(o,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Hc(o){let t="precision "+o.precision+` float;
precision `+o.precision+" int;";return o.precision==="highp"?t+=`
#define HIGH_PRECISION`:o.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:o.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function Cg(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===Ch?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===zd?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===Jn&&(t="SHADOWMAP_TYPE_VSM"),t}function Pg(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case Is:case Ds:t="ENVMAP_TYPE_CUBE";break;case Er:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Lg(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Ds:t="ENVMAP_MODE_REFRACTION";break}return t}function Ig(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case nl:t="ENVMAP_BLENDING_MULTIPLY";break;case du:t="ENVMAP_BLENDING_MIX";break;case uu:t="ENVMAP_BLENDING_ADD";break}return t}function Dg(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Ug(o,t,e,n){const i=o.getContext(),s=e.defines;let r=e.vertexShader,a=e.fragmentShader;const l=Cg(e),c=Pg(e),u=Lg(e),h=Ig(e),d=Dg(e),f=e.isWebGL2?"":vg(e),y=Mg(e),g=bg(s),m=i.createProgram();let p,x,_=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `,document.body.appendChild(n),this.crashOverlay=n,requestAnimationFrame(()=>{n.style.opacity="1"}),n.querySelector("#crash-menu").addEventListener("click",()=>{this.onCrashAction?.("menu")}),n.querySelector("#crash-restart").addEventListener("click",()=>{this.onCrashAction?.("restart")})}updateExplosion(t){if(this.explosionMeshes.length>0)for(let e=this.explosionMeshes.length-1;e>=0;e--){const n=this.explosionMeshes[e],i=n._age+t;n._age=i;const s=n._life,r=i/s;if(r>=1){this.sceneMgr.scene.remove(n),n.geometry.dispose(),n.material.dispose(),this.explosionMeshes.splice(e,1);continue}const a=n._shockRing,l=a?1+r*60:1+r*6;n.scale.setScalar(l);const c=s<1?2:1;n.material.opacity=a?Math.max(0,.85*(1-r*1.5)):Math.max(0,.9*(1-r*c)),n.position.x+=n._vx*t,n.position.y+=n._vy*t,n.position.z+=n._vz*t}}explosionMeshes=[];spawnExplosion(t,e,n){const i=[16746496,16729088,16720384,16737792,13386752,16755200],s=new ct(new ge(.8,12,8),new Ae({color:16755200,transparent:!0,opacity:1,blending:dn,depthWrite:!1}));s.position.set(t,e,n),s._life=.8,s._age=0,this.sceneMgr.scene.add(s),this.explosionMeshes.push(s);for(let r=0;r<8;r++){const a=1+Math.random()*1.5,l=new ge(a,8,6),c=new Ae({color:i[r%i.length],transparent:!0,opacity:.9,blending:dn,depthWrite:!1}),u=new ct(l,c),h=r/8*Math.PI*2,d=Math.random()*Math.PI,f=.3;u.position.set(t+Math.sin(h)*Math.cos(d)*f,e+Math.sin(d)*f,n+Math.cos(h)*Math.cos(d)*f),u._life=1.5+Math.random()*.5,u._age=0,u._vx=Math.sin(h)*Math.cos(d)*(1+Math.random()*3),u._vy=Math.sin(d)*(1+Math.random()*3),u._vz=Math.cos(h)*Math.cos(d)*(1+Math.random()*3),this.sceneMgr.scene.add(u),this.explosionMeshes.push(u)}for(let r=0;r<4;r++){const a=1.5+Math.random()*2,l=new Ae({color:4473924,transparent:!0,opacity:.4,blending:Ti,depthWrite:!1}),c=new ct(new ge(a,6,6),l),u=r/4*Math.PI*2+Math.random()*.5;c.position.set(t+Math.cos(u)*.5,e+(Math.random()-.5)*.3,n+Math.sin(u)*.5),c._life=2+Math.random()*.5,c._age=0,c._vx=Math.cos(u)*(.5+Math.random()*1.5),c._vy=(Math.random()-.5)*1,c._vz=Math.sin(u)*(.5+Math.random()*1.5),this.sceneMgr.scene.add(c),this.explosionMeshes.push(c)}}spawnShockRing(t=16777215){const e=new P;this.rocketGroup.getWorldPosition(e),e.x*Pt,e.y*Pt,e.z*Pt;const n=new Ai(.1,.2,64),i=new Ae({color:t,transparent:!0,opacity:.85,side:He,blending:dn,depthWrite:!1}),s=new ct(n,i);s.position.set(this.rocketGroup.position.x,this.rocketGroup.position.y,this.rocketGroup.position.z),s.quaternion.copy(this.rocketQuat),s.scale.setScalar(1),s._life=1.2,s._age=0,s._shockRing=!0,s._vx=0,s._vy=0,s._vz=0,this.sceneMgr.scene.add(s),this.explosionMeshes.push(s)}hasLandingLegs(){const t=e=>{for(const n of e)if(n.part.kind==="legs"||t(n.children))return!0;return!1};return t(this.rocket.assembly.roots)}positionFlameAtNozzle(){let t=1/0;const e=this.rocketGroup.matrixWorld.clone().invert();this.rocketGroup.traverse(i=>{if(i instanceof ct){if(this.gearMeshes.includes(i)||i===this.rocketShadow||i===this.reentryGlow||i===this.reentryGlowMesh||i.name==="reentry-outer")return;const r=new xn().setFromObject(i).applyMatrix4(e);r.min.y<t&&(t=r.min.y)}}),this.rocketBottomY=t===1/0?-.1:t;const n=t===1/0?-.1:t-.01;this.engineFlame.getMesh().position.set(0,n,0),this.engineFlame.getMesh().rotation.set(0,0,0)}dispose(){if(!this.crashed){const t=this.rocket.assembly.roots;r_({assembly:Cd(this.rocket.assembly),fuel:t.map(e=>{const n=this.rocket.fuelTanks.find(i=>i.node===e);return n?n.remaining:0}),position:[...this.state.position],velocity:[...this.state.velocity],throttle:this.state.throttle,missionTime:this.missionTime,quat:[this.rocketQuat.x,this.rocketQuat.y,this.rocketQuat.z,this.rocketQuat.w],launched:this.launched,grounded:this.grounded,groundedDir:this.groundedDir?[...this.groundedDir]:null,bodies:this.system.bodies.map(e=>({name:e.name,position:[...e.position],velocity:[...e.velocity??[0,0,0]]}))})}this.crashOverlay&&(this.crashOverlay.remove(),this.crashOverlay=null),this.hideAutopilotStatus(),this.sceneMgr.scene.remove(this.rocketGroup);for(const t of this.debris)this.sceneMgr.scene.remove(t.mesh);this.debris=[];for(const t of this.explosionMeshes)this.sceneMgr.scene.remove(t),t.geometry.dispose(),t.material.dispose();this.explosionMeshes=[],this.controls.dispose(),this.chase.dispose(),this.engineFlame.dispose(),this.groundSmoke.dispose(),this.hud.unmount(),this.sound.dispose()}}function T_(o,t,e){const n=o.mass,i=[...o.position],s=[...o.velocity],r=Oe(t(o),1/n),a=s,c=Aa(o,Ye(i,Oe(r,.5*e)),Ye(s,Oe(a,.5*e))),u=Oe(t(c),1/n),h=Ye(s,Oe(r,.5*e)),f=Aa(o,Ye(i,Oe(u,.5*e)),Ye(s,Oe(h,.5*e))),y=Oe(t(f),1/n),g=Ye(s,Oe(u,.5*e)),p=Aa(o,Ye(i,Oe(y,e)),Ye(s,Oe(g,e))),x=Oe(t(p),1/n),_=Ye(s,Oe(y,e)),b=Oe(Ye(Ye(r,Oe(u,2)),Ye(Oe(y,2),x)),e/6),R=Oe(Ye(Ye(a,Oe(h,2)),Ye(Oe(g,2),_)),e/6);o.position=Ye(i,R),o.velocity=Ye(s,b)}function Aa(o,t,e){return{...o,position:t,velocity:e}}function Ye(o,t){return[o[0]+t[0],o[1]+t[1],o[2]+t[2]]}function Oe(o,t){return[o[0]*t,o[1]*t,o[2]*t]}class E_{bodies=[];add(t){this.bodies.push(t)}bodyByName(t){return this.bodies.find(e=>e.name===t)}propagate(t,e){let n=t;for(;n>0;){const i=Math.min(e,n);this.step(i),n-=i}}step(t){for(const e of this.bodies){if(e.mass<=0)continue;const n=Ud(e,this.bodies);T_(e,()=>n,t)}}}const di=fn*pn;class Wn extends vl{radius;visualRadius;mesh;constructor(t,e,n,i,s){super(t,e,n,i),this.radius=s,this.visualRadius=s*di;const r=new ge(this.visualRadius,64,32),a=new oe({color:8421504});this.mesh=new ct(r,a),this.mesh.position.set(n[0]*di,n[1]*di,n[2]*di)}getTerrainHeightVisual(t,e,n){return 0}syncMesh(){this.mesh.position.set(this.position[0]*di,this.position[1]*di,this.position[2]*di)}getSurfaceRadiusAt(t){const e=t[0]-this.position[0],n=t[1]-this.position[1],i=t[2]-this.position[2],s=Math.sqrt(e*e+n*n+i*i);if(s===0)return this.radius;const r=e/s,a=n/s,l=i/s,u=this.getTerrainHeightVisual(r,a,l)/di;return this.radius+u}}const Ra=fn*pn,xh=64,ui=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},w_=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=ui(n,i,s),f=ui(n+1,i,s),y=ui(n,i+1,s),g=ui(n+1,i+1,s),m=ui(n,i,s+1),p=ui(n+1,i,s+1),x=ui(n,i+1,s+1),_=ui(n+1,i+1,s+1);return Hi(Hi(Hi(d,f,c),Hi(y,g,c),u),Hi(Hi(m,p,c),Hi(x,_,c),u),h)},rr=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*w_(o*l,t*l,e*l),r+=s,s*=.5}return i/r},Hi=(o,t,e)=>o+(t-o)*e;class A_ extends Wn{getTerrainHeightVisual(t,e,n){const i=rr(t*10+500,e*10+600,n*10+700,4),s=rr(t*40+100,e*40+200,n*40+300,3),r=i*.8+s*.2,a=this.visualRadius*.03;return r>.4?((r-.4)/.6)**2*a:-(.4-r)/.4*a*.12}constructor(t,e){super("mercury",1e24,t,e,244e4);const n=this.visualRadius,s=new Xs().load(qs("/textures/mercury.jpg"),h=>{h.colorSpace=se,h.anisotropy=4}),r=new ge(n,xh,xh),a=r.attributes.position,l=new P,c=n*.03;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const d=l.x/n,f=l.y/n,y=l.z/n,g=rr(d*10+500,f*10+600,y*10+700,4),m=rr(d*40+100,f*40+200,y*40+300,3),p=g*.8+m*.2;let x=0;p>.4?x=((p-.4)/.6)**2*c:x=-(.4-p)/.4*c*.12,l.setLength(n+x),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const u=new oe({map:s,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(r,u),this.mesh.position.set(t[0]*Ra,t[1]*Ra,t[2]*Ra)}}const _h=`
...
`;class ns{group=new an;innerMesh;outerMesh;innerMat;outerMat;constructor(t,e=4491519,n=.7,i,s=16737826,r=3){const a=new Rt(e),l=new Rt(s),c=i??t*.08,u=new P(0,0,0),h=t*1.01,d=new ge(h,64,48);this.innerMat=new Dn({vertexShader:_h,fragmentShader:R_,uniforms:{uSunDir:{value:new P(0,1,0)},uPlanetCenter:{value:u},uInnerRadius:{value:t},uAtmHeight:{value:c},uRayleighCol:{value:a},uMieCol:{value:new Rt(.9,.9,1)},uDensity:{value:n},uTerminatorCol:{value:l},uGlowPower:{value:r}},transparent:!0,blending:dn,depthWrite:!1,side:In}),this.innerMesh=new ct(d,this.innerMat),this.group.add(this.innerMesh);const f=t*1.06,y=new ge(f,48,32);this.outerMat=new Dn({vertexShader:_h,fragmentShader:C_,uniforms:{uSunDir:{value:new P(0,1,0)},uPlanetCenter:{value:u},uInnerRadius:{value:t},uDensity:{value:n*.5},uGlowPower:{value:r}},transparent:!0,blending:dn,depthWrite:!1,side:In}),this.outerMesh=new ct(y,this.outerMat),this.group.add(this.outerMesh)}setSunDirection(t,e){const n=new P().copy(t).sub(e).normalize();this.innerMat.uniforms.uSunDir.value.copy(n),this.outerMat.uniforms.uSunDir.value.copy(n)}getMesh(){return this.group}dispose(){this.innerMat.dispose(),this.outerMat.dispose(),this.innerMesh.geometry.dispose(),this.outerMesh.geometry.dispose()}}const Ca=fn*pn,vh=64,fi=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},P_=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=fi(n,i,s),f=fi(n+1,i,s),y=fi(n,i+1,s),g=fi(n+1,i+1,s),m=fi(n,i,s+1),p=fi(n+1,i,s+1),x=fi(n,i+1,s+1),_=fi(n+1,i+1,s+1);return Bi(Bi(Bi(d,f,c),Bi(y,g,c),u),Bi(Bi(m,p,c),Bi(x,_,c),u),h)},ar=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*P_(o*l,t*l,e*l),r+=s,s*=.5}return i/r},Bi=(o,t,e)=>o+(t-o)*e;class L_ extends Wn{getTerrainHeightVisual(t,e,n){const i=ar(t*6+50,e*6+100,n*6+150,4),s=ar(t*15+200,e*15+300,n*15+400,3),r=i*.6+s*.4,a=this.visualRadius*.015;return r>.35?((r-.35)/.65)**2*a:-(.35-r)/.35*a*.05}atmosphereGlow;constructor(t,e){super("venus",146e23,t,e,6052e3);const n=this.visualRadius,s=new Xs().load(qs("/textures/venus.jpg"),h=>{h.colorSpace=se,h.anisotropy=4}),r=new ge(n,vh,vh),a=r.attributes.position,l=new P,c=n*.015;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const d=l.x/n,f=l.y/n,y=l.z/n,g=ar(d*6+50,f*6+100,y*6+150,4),m=ar(d*15+200,f*15+300,y*15+400,3),p=g*.6+m*.4;let x=0;p>.35?x=((p-.35)/.65)**2*c:x=-(.35-p)/.35*c*.05,l.setLength(n+x),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const u=new oe({map:s,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(r,u),this.mesh.position.set(t[0]*Ca,t[1]*Ca,t[2]*Ca),this.atmosphereGlow=new ns(n,15247436,.4),this.mesh.add(this.atmosphereGlow.getMesh())}}const Pa=fn*pn;class I_ extends Wn{constructor(t,e){super("pluto",44e20,t,e,1188e3);const n=new ge(this.visualRadius,32,16),i=new oe({color:14535867,roughness:.9,metalness:0});this.mesh=new ct(n,i),this.mesh.position.set(t[0]*Pa,t[1]*Pa,t[2]*Pa)}}const La=fn*pn;function D_(o){let t=o|0;return()=>{t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function U_(){const e=document.createElement("canvas");e.width=2048,e.height=1024;const n=e.getContext("2d"),i=n.createImageData(2048,1024);for(let r=0;r<1024;r++)for(let a=0;a<2048;a++){const l=r/1024,c=a/2048,u=(l-.5)*Math.PI,h=c*Math.PI*2,d=Math.cos(u)*Math.cos(h),f=Math.cos(u)*Math.sin(h),y=Math.sin(u);let g=(Math.sin(d*3+f*1.3+y*.7)*.5+.5)*.4+(Math.sin((d+1.7)*6+y*1.1)*.5+.5)*.3;g*=Math.max(0,1-Math.abs(l-.5)*1.2),g=Math.max(0,Math.min(255,(g-.4)*2.5*255));const m=(r*2048+a)*4;i.data[m]=i.data[m+1]=i.data[m+2]=g,i.data[m+3]=255}n.putImageData(i,0,0);const s=new en(e);return s.wrapS=s.wrapT=Be,s}function N_(){const e=document.createElement("canvas");e.width=1024,e.height=512;const n=e.getContext("2d");n.fillStyle="#000000",n.fillRect(0,0,1024,512);const i=D_(42),s=[{lat:.7,lon:-1.8,rx:.5,ry:.8},{lat:-.4,lon:-1.3,rx:.6,ry:.35},{lat:.1,lon:.6,rx:.55,ry:.4},{lat:.5,lon:1.5,rx:.6,ry:.4},{lat:.85,lon:.4,rx:.25,ry:.3}];for(const a of s){const l=(a.lon+Math.PI)/(2*Math.PI)*1024,c=(Math.PI/2-a.lat)/Math.PI*512,u=a.rx/(2*Math.PI)*1024,h=a.ry/Math.PI*512;for(let d=0;d<30;d++){const f=(i()-.5)*u*2,y=(i()-.5)*h*2;if((f/u)**2+(y/h)**2>1)continue;const g=120+Math.floor(i()*135);n.fillStyle=`rgb(${g},${Math.floor(g*.85)},${Math.floor(g*.5)})`,n.beginPath(),n.arc(l+f,c+y,1+i()*3,0,Math.PI*2),n.fill()}}const r=new en(e);return r.wrapS=r.wrapT=Be,r.colorSpace=se,r}class F_ extends Wn{atmosphereGlow;cloudMesh;constructor(t,e){super("earth",Px,t,e,6371e3*2);const n=this.visualRadius,i=320,s=new ge(n,i,i),r=s.attributes.position,a=new P,l=[],c=n*.035,u=n*.007;for(let g=0;g<r.count;g++){a.fromBufferAttribute(r,g);const m=a.x/n,p=a.y/n,x=a.z/n,_=this.terrainAt(m,p,x,c,u);a.setLength(n+_),r.setXYZ(g,a.x,a.y,a.z);const b=Math.max(-1,Math.min(1,_/c));let R,A,S;b<-.6?(R=.005,A=.04,S=.22):b<-.15?(R=.02,A=.1,S=.38):b<.02?(R=.5,A=.46,S=.28):b<.22?(R=.12,A=.35,S=.08):b<.5?(R=.18,A=.25,S=.08):b<.78?(R=.35,A=.3,S=.2):(R=.92,A=.88,S=.85),l.push(R,A,S)}r.needsUpdate=!0,s.setAttribute("color",new we(l,3)),s.computeVertexNormals();const h=new oe({roughness:.85,metalness:.05,vertexColors:!0,emissiveMap:N_(),emissive:new Rt(16768358),emissiveIntensity:.3});this.mesh=new ct(s,h),this.mesh.position.set(t[0]*La,t[1]*La,t[2]*La),this.loadTexture().catch(()=>{}),this.atmosphereGlow=new ns(n,4491519,2.5,n*.1),this.mesh.add(this.atmosphereGlow.getMesh());const d=U_(),f=new oe({map:d,transparent:!0,opacity:.3,depthWrite:!1,side:He,roughness:1,metalness:0}),y=new ge(n*1.008,64,32);this.cloudMesh=new ct(y,f),this.cloudMesh.position.copy(this.mesh.position),this.mesh.add(this.cloudMesh)}terrainAt(t,e,n,i,s){const r=Math.sin(t*5+e*3.5)*.5+Math.cos(e*4.5-n*3)*.3,a=Math.sin(n*7+t*3+e*5)*.2+Math.sin(t*13+e*9+n*11)*.12,l=Math.sin(t*20+n*16)*.06+Math.cos(e*18+t*13)*.04,c=Math.sin(t*38+e*33+n*42)*.02,u=((r+a+l+c)*.35+.5)*1.05;if(u>.48){const h=(u-.48)/.52;return h*h*i}return u>.38?(u-.38)/.1*i*.2:-(.38-u)/.38*s}async loadTexture(){try{const t=await new Xs().loadAsync(qs("/textures/earth_daymap.jpg"));t.colorSpace=se,this.mesh.material.map=t,this.mesh.material.needsUpdate=!0}catch{}}updateClouds(t,e){if(this.cloudMesh.rotation.y+=t*.01,e){const n=this.mesh.material,i=Math.sqrt(e[0]**2+e[1]**2+e[2]**2)||1;this.mesh.lookAt(this.mesh.position.x+e[0]/i*100,this.mesh.position.y+e[1]/i*100,this.mesh.position.z+e[2]/i*100),n.emissiveIntensity=.15}}}const Ia=fn*pn,Mh=64,pi=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},k_=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=pi(n,i,s),f=pi(n+1,i,s),y=pi(n,i+1,s),g=pi(n+1,i+1,s),m=pi(n,i,s+1),p=pi(n+1,i,s+1),x=pi(n,i+1,s+1),_=pi(n+1,i+1,s+1);return zi(zi(zi(d,f,c),zi(y,g,c),u),zi(zi(m,p,c),zi(x,_,c),u),h)},lr=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*k_(o*l,t*l,e*l),r+=s,s*=.5}return i/r},zi=(o,t,e)=>o+(t-o)*e;class O_ extends Wn{getTerrainHeightVisual(t,e,n){const i=lr(t*8+100,e*8+200,n*8+300,4),s=lr(t*30+400,e*30+500,n*30+600,3),r=i*.7+s*.3,a=this.visualRadius*.04;return r>.45?((r-.45)/.55)**2*a:-(.45-r)/.45*a*.15}constructor(t,e){super("moon",22e22,t,e,1737e3);const n=this.visualRadius,s=new Xs().load(qs("/textures/moon.jpg"),h=>{h.colorSpace=se,h.anisotropy=4}),r=new ge(n,Mh,Mh),a=r.attributes.position,l=new P,c=n*.04;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const d=l.x/n,f=l.y/n,y=l.z/n,g=lr(d*8+100,f*8+200,y*8+300,4),m=lr(d*30+400,f*30+500,y*30+600,3),p=g*.7+m*.3;let x=0;p>.45?x=((p-.45)/.55)**2*c:x=-(.45-p)/.45*c*.15,l.setLength(n+x),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const u=new oe({map:s,roughness:.95,metalness:0,color:16777215});this.mesh=new ct(r,u),this.mesh.position.set(t[0]*Ia,t[1]*Ia,t[2]*Ia)}}const Da=fn*pn,bh=64,mi=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},H_=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=mi(n,i,s),f=mi(n+1,i,s),y=mi(n,i+1,s),g=mi(n+1,i+1,s),m=mi(n,i,s+1),p=mi(n+1,i,s+1),x=mi(n,i+1,s+1),_=mi(n+1,i+1,s+1);return Gi(Gi(Gi(d,f,c),Gi(y,g,c),u),Gi(Gi(m,p,c),Gi(x,_,c),u),h)},cr=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*H_(o*l,t*l,e*l),r+=s,s*=.5}return i/r},Gi=(o,t,e)=>o+(t-o)*e;class B_ extends Wn{getTerrainHeightVisual(t,e,n){const i=cr(t*4+10,e*4+20,n*4+30,5),s=cr(t*20+100,e*20+200,n*20+300,3),r=i*.7+s*.3,a=this.visualRadius*.035;return r>.4?((r-.4)/.6)**2*a:-(.4-r)/.4*a*.1}atmosphereGlow;constructor(t,e){super("mars",19e23,t,e,339e4);const n=this.visualRadius,s=new Xs().load(qs("/textures/mars.jpg"),h=>{h.colorSpace=se,h.anisotropy=4}),r=new ge(n,bh,bh),a=r.attributes.position,l=new P,c=n*.035;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const d=l.x/n,f=l.y/n,y=l.z/n,g=cr(d*4+10,f*4+20,y*4+30,5),m=cr(d*20+100,f*20+200,y*20+300,3),p=g*.7+m*.3;let x=0;p>.4?x=((p-.4)/.6)**2*c:x=-(.4-p)/.4*c*.1,l.setLength(n+x),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const u=new oe({map:s,roughness:.85,metalness:0,color:16777215});this.mesh=new ct(r,u),this.mesh.position.set(t[0]*Da,t[1]*Da,t[2]*Da),this.atmosphereGlow=new ns(n,13920842,.25),this.mesh.add(this.atmosphereGlow.getMesh())}}function gi(o,t,e){const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)}function z_(o,t,e){const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),u=a*a*(3-2*a),h=l*l*(3-2*l),d=gi(n,i,s),f=gi(n+1,i,s),y=gi(n,i+1,s),g=gi(n+1,i+1,s),m=gi(n,i,s+1),p=gi(n+1,i,s+1),x=gi(n,i+1,s+1),_=gi(n+1,i+1,s+1);return Wi(Wi(Wi(d,f,c),Wi(y,g,c),u),Wi(Wi(m,p,c),Wi(x,_,c),u),h)}function Ri(o,t,e,n){let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*z_(o*l,t*l,e*l),r+=s,s*=.5}return i/r}function Wi(o,t,e){return o+(t-o)*e}const Ua=fn*pn,Sh=64;class G_ extends Wn{atmosphereGlow;constructor(t,e){super("jupiter",19e26,t,e,69911e3);const n=this.visualRadius,i=Hx(),s=new ge(n,Sh,Sh),r=s.attributes.position,a=new P,l=n*.02;for(let u=0;u<r.count;u++){a.fromBufferAttribute(r,u);const h=a.x/n,d=a.y/n,f=a.z/n,y=Ri(h*8+10,d*8+20,f*8+30,4),g=Ri(h*30+100,d*30+200,f*30+300,3),m=y*.7+g*.3;let p=0;m>.4?p=((m-.4)/.6)**2*l:p=-(.4-m)/.4*l*.1,a.setLength(n+p),r.setXYZ(u,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new oe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*Ua,t[1]*Ua,t[2]*Ua),this.mesh.rotation.z=3.1*Math.PI/180,this.atmosphereGlow=new ns(n,13935988,.15),this.mesh.add(this.atmosphereGlow.getMesh())}}const Na=fn*pn;function W_(){const e=document.createElement("canvas");e.width=1024,e.height=64;const n=e.getContext("2d"),i=n.createLinearGradient(0,0,1024,0);i.addColorStop(0,"#8a7a5a"),i.addColorStop(.05,"#b8a888"),i.addColorStop(.12,"#d4c8a8"),i.addColorStop(.2,"#c0b898"),i.addColorStop(.35,"#e8ddd0"),i.addColorStop(.5,"#c0b090"),i.addColorStop(.65,"#d8ccb0"),i.addColorStop(.8,"#a89878"),i.addColorStop(.9,"#786858"),i.addColorStop(1,"#584838"),n.fillStyle=i,n.fillRect(0,0,1024,64);for(let r=0;r<8e3;r++){const a=Math.random()*1024,l=Math.random()*64,c=1+Math.random()*4,u=120+Math.random()*80;n.fillStyle=`rgba(${u},${u-20},${u-40},${.2+Math.random()*.4})`,n.beginPath(),n.arc(a,l,c,0,Math.PI*2),n.fill()}n.fillStyle="rgba(0,0,0,0.7)",n.fillRect(1024*.43,0,1024*.04,64),n.fillStyle="rgba(0,0,0,0.4)",n.fillRect(1024*.72,0,1024*.015,64),n.fillStyle="rgba(0,0,0,0.3)",n.fillRect(1024*.1,0,1024*.02,64),n.fillRect(1024*.17,0,1024*.01,64),n.fillRect(1024*.55,0,1024*.02,64),n.fillStyle="rgba(200,190,170,0.15)";for(let r=0;r<1024;r+=8)n.fillRect(r,0,2,64);const s=new en(e);return s.wrapS=Be,s.wrapT=Be,s.anisotropy=4,s}class V_ extends Wn{atmosphereGlow;constructor(t,e){super("saturn",5683e23,t,e,58232e3);const n=this.visualRadius,i=Bx(),s=new ge(n,64,32),r=s.attributes.position,a=new P,l=n*.015;for(let p=0;p<r.count;p++){a.fromBufferAttribute(r,p);const x=a.x/n,_=a.y/n,b=a.z/n,R=Ri(x*8+10,_*8+20,b*8+30,4),A=Ri(x*30+100,_*30+200,b*30+300,3),S=R*.7+A*.3;let O=0;S>.4?O=((S-.4)/.6)**2*l:O=-(.4-S)/.4*l*.1,a.setLength(n+O),r.setXYZ(p,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new oe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*Na,t[1]*Na,t[2]*Na),this.mesh.rotation.z=26.7*Math.PI/180,this.atmosphereGlow=new ns(n,16049313,.1),this.mesh.add(this.atmosphereGlow.getMesh());const u=W_(),h=new Ai(n*1.15,n*2.4,256),d=new Ae({map:u,side:He,transparent:!0,opacity:.8,depthWrite:!1}),f=new ct(h,d);f.rotation.x=-Math.PI/2,f.rotation.z=26.7*Math.PI/180,this.mesh.add(f);const y=new Ai(n*2.4,n*2.8,128),g=new Ae({color:8943720,side:He,transparent:!0,opacity:.15,depthWrite:!1}),m=new ct(y,g);m.rotation.x=-Math.PI/2,m.rotation.z=26.7*Math.PI/180,this.mesh.add(m)}}const Fa=fn*pn;class X_ extends Wn{atmosphereGlow;constructor(t,e){super("uranus",8681e22,t,e,25362e3);const n=this.visualRadius,i=zx(),s=new ge(n,64,32),r=s.attributes.position,a=new P,l=n*.015;for(let f=0;f<r.count;f++){a.fromBufferAttribute(r,f);const y=a.x/n,g=a.y/n,m=a.z/n,p=Ri(y*6+10,g*6+20,m*6+30,4),x=Ri(y*25+400,g*25+500,m*25+600,3),_=p*.7+x*.3;let b=0;_>.4?b=((_-.4)/.6)**2*l:b=-(.4-_)/.4*l*.1,a.setLength(n+b),r.setXYZ(f,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new oe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*Fa,t[1]*Fa,t[2]*Fa),this.mesh.rotation.z=-97.8*Math.PI/180,this.atmosphereGlow=new ns(n,5230824,.1),this.mesh.add(this.atmosphereGlow.getMesh());const u=new Ai(n*1.2,n*2.1,64),h=new Ae({color:11184844,side:He,transparent:!0,opacity:.3}),d=new ct(u,h);d.rotation.x=-Math.PI/2,d.rotation.z=97.8*Math.PI/180,this.mesh.add(d)}}const ka=fn*pn;class q_ extends Wn{atmosphereGlow;constructor(t,e){super("neptune",1024e23,t,e,24622e3);const n=this.visualRadius,i=Gx(),s=new ge(n,64,32),r=s.attributes.position,a=new P,l=n*.015;for(let u=0;u<r.count;u++){a.fromBufferAttribute(r,u);const h=a.x/n,d=a.y/n,f=a.z/n,y=Ri(h*6+10,d*6+20,f*6+30,4),g=Ri(h*25+100,d*25+200,f*25+300,3),m=y*.7+g*.3;let p=0;m>.4?p=((m-.4)/.6)**2*l:p=-(.4-m)/.4*l*.1,a.setLength(n+p),r.setXYZ(u,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new oe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new ct(s,c),this.mesh.position.set(t[0]*ka,t[1]*ka,t[2]*ka),this.mesh.rotation.z=28.3*Math.PI/180,this.atmosphereGlow=new ns(n,4944093,.15),this.mesh.add(this.atmosphereGlow.getMesh())}}const ws=fn*pn,Y_=`
varying vec2 vUv;
void main() {
  vUv = uv;
...
`;class K_ extends vl{light;visualRadius;mesh;constructor(t,e,n=2e26){super("sun",n,t,e),this.visualRadius=100;const i=new ge(this.visualRadius,32,16),s=new Dn({vertexShader:Y_,fragmentShader:$_,uniforms:{uTime:{value:0},uColor:{value:new Rt(16763904)},uIntensity:{value:1.5}},transparent:!0,blending:dn,depthWrite:!1,side:He});this.mesh=new ct(i,s),this.mesh.position.set(t[0]*ws,t[1]*ws,t[2]*ws),this.light=new Ir(16772829,5),this.light.position.set(this.mesh.position.x+100,this.mesh.position.y+50,this.mesh.position.z);const r=j_(),a=new cd({map:r,blending:dn,depthWrite:!1,transparent:!0,opacity:1}),l=new ly(a);l.scale.set(25e4,25e4,1),this.mesh.add(l),this.sunMaterial=s}sunMaterial;update(t){this.sunMaterial.uniforms.uTime.value+=t}syncMesh(){this.mesh.position.set(this.position[0]*ws,this.position[1]*ws,this.position[2]*ws),this.light.position.set(this.mesh.position.x+100,this.mesh.position.y+50,this.mesh.position.z)}}function j_(){const t=document.createElement("canvas");t.width=256,t.height=256;const e=t.getContext("2d"),n=e.createRadialGradient(256/2,256/2,0,256/2,256/2,256/2);n.addColorStop(0,"rgba(255, 220, 100, 1)"),n.addColorStop(.1,"rgba(255, 200, 80, 0.8)"),n.addColorStop(.3,"rgba(255, 160, 40, 0.4)"),n.addColorStop(.5,"rgba(255, 100, 20, 0.15)"),n.addColorStop(.7,"rgba(255, 60, 10, 0.05)"),n.addColorStop(1,"rgba(255, 0, 0, 0)"),e.fillStyle=n,e.fillRect(0,0,256,256);const i=new en(t);return i.needsUpdate=!0,i}class hr{assembly;fuelTanks;constructor(t){this.assembly=t,this.fuelTanks=[],Nd(t.roots,this.fuelTanks),this.fuelTanks.sort((e,n)=>n.node.position[1]-e.node.position[1])}dryMass(){return this.assembly.totalMass()}totalFuelMass(){return this.fuelTanks.reduce((t,e)=>t+e.remaining,0)}totalMass(){return this.dryMass()+this.totalFuelMass()}consumeFuel(t,e){let n=0;for(let i=this.fuelTanks.length-1;i>=0;i--){const s=this.fuelTanks[i];if(s.remaining<=0)continue;const r=t*e-n;if(r<=0)break;const a=Math.min(s.remaining,r);s.remaining-=a,n+=a}return n}removeStage(t){const e=this.assembly.roots,n=t.position[1],i=new Set,s=r=>{i.add(r),r.children.forEach(s)};for(const r of e)(r===t||r.position[1]<n)&&s(r);this.fuelTanks=this.fuelTanks.filter(r=>!i.has(r.node)),this.assembly.roots=e.filter(r=>!i.has(r)),t.children=[]}}function Nd(o,t){for(const e of o)e.part.fuelCapacity&&t.push({node:e,remaining:e.part.fuelCapacity,capacity:e.part.fuelCapacity}),Nd(e.children,t)}const Th="ellipse_achievements";class Z_{unlocked=new Set;callbacks=[];constructor(){const t=localStorage.getItem(Th);if(t)try{JSON.parse(t).forEach(e=>this.unlocked.add(e))}catch{}}unlock(t){this.unlocked.has(t)||(this.unlocked.add(t),localStorage.setItem(Th,JSON.stringify([...this.unlocked])),this.callbacks.forEach(e=>e(t)))}isUnlocked(t){return this.unlocked.has(t)}list(){return[...this.unlocked]}onUnlock(t){this.callbacks.push(t)}}const J_=[{id:"first_launch",name:"First Launch",description:"Successful liftoff from the pad"},{id:"reach_space",name:"Edge of Space",description:"Reach 100 km altitude"},{id:"reach_orbit",name:"Orbital",description:"Achieve a stable orbit"},{id:"first_landing",name:"Soft Touchdown",description:"Land at v < 3 m/s"},{id:"parachute_landing",name:"Parachute Pioneer",description:"Land using only a parachute"},{id:"moon_landing",name:"Moon Walker",description:"Land on the Moon"},{id:"no_damage",name:"Pristine",description:"Complete a flight without damage"},{id:"one_stage",name:"Single Stage",description:"Reach orbit without staging"},{id:"crash",name:"Rapid Unscheduled Disassembly",description:"Crash your rocket"},{id:"land_earth",name:"Home Sweet Home",description:"Land safely on Earth"},{id:"land_moon",name:"Lunar Landing",description:"Land safely on the Moon"},{id:"land_mars",name:"Red Planet Touchdown",description:"Land safely on Mars"},{id:"land_venus",name:"Venusian Visit",description:"Land safely on Venus"},{id:"land_mercury",name:"Mercurial Touch",description:"Land safely on Mercury"},{id:"stage_separate",name:"Stage Separation",description:"Separate a stage in flight"}],Eh="ellipse_missions_completed",wh="ellipse_missions_score";class Q_{completed=new Set;stageCountThisFlight=0;landedThisFrame=!1;score=0;onScoreChange=[];constructor(){const t=localStorage.getItem(Eh);if(t)try{JSON.parse(t).forEach(e=>this.completed.add(e))}catch{}this.score=parseInt(localStorage.getItem(wh)??"0",10)||0}get totalScore(){return this.score}getCompleted(){return[...this.completed]}isCompleted(t){return this.completed.has(t)}onScore(t){this.onScoreChange.push(t)}recordStageSeparation(){this.stageCountThisFlight++,this.tryUnlock("stage_master",this.stageCountThisFlight>=3)}recordLanding(t){this.landedThisFrame=!0,t==="earth"?this.tryUnlock("land_earth",!0):t==="moon"?this.tryUnlock("land_moon",!0):t==="mars"&&this.tryUnlock("land_mars",!0)}resetFlight(){this.stageCountThisFlight=0,this.landedThisFrame=!1}evaluate(t){t.launched&&this.tryUnlock("first_flight",!0),t.maxAltitude>=1e4&&this.tryUnlock("reach_10km",!0),t.maxAltitude>=1e5&&this.tryUnlock("reach_space",!0),t.maxSpeed>=3e3&&this.tryUnlock("speed_demon",!0),t.maxSpeed>=7e3&&this.tryUnlock("ev_astronaut",!0),t.bound&&t.periapsis>8e4&&t.refBody==="earth"&&this.tryUnlock("reach_orbit",!0),t.bound&&t.apoapsis>5e5&&t.refBody==="earth"&&this.tryUnlock("high_orbit",!0),t.bound&&t.periapsis>1e3&&t.refBody==="moon"&&this.tryUnlock("munar_orbit",!0)}tryUnlock(t,e){if(!e||this.completed.has(t))return;this.completed.add(t),localStorage.setItem(Eh,JSON.stringify([...this.completed]));const n=gr.find(i=>i.id===t);n&&(this.score+=n.reward,localStorage.setItem(wh,String(this.score)),this.onScoreChange.forEach(i=>i(this.score)),Xt.show(`☑ ${n.name} (+${n.reward})`,3200))}}const Oa={units:"metric",autoSave:!0,difficulty:"normal",musicVolume:.7,sfxVolume:.8},Fd="ellipse_settings";function tv(){const o=localStorage.getItem(Fd);if(!o)return{...Oa};try{return{...Oa,...JSON.parse(o)}}catch{return{...Oa}}}function Ah(o){localStorage.setItem(Fd,JSON.stringify(o))}class ev{root;onClose;current;constructor(t,e){this.current=t,this.onClose=e,this.root=document.createElement("div"),this.root.style.cssText=`
    ...
    `;const e=document.createElement("style");e.textContent="@keyframes spin{to{transform:rotate(360deg);}}",document.head.appendChild(e),document.body.appendChild(t);const n=t.querySelector("#load-progress"),i=["/models/agena.glb","/models/saturn_v.glb","/models/apollo_soyuz.glb","/models/ares_1.glb","/models/apollo_lunar_module.glb","/models/atlas_6.glb","/models/atlas_9.glb","/models/crawler.glb"],{loadGLTF:s}=await Rh(async()=>{const{loadGLTF:a}=await Promise.resolve().then(()=>wd);return{loadGLTF:a}},void 0);let r=0;await Promise.allSettled(i.map(async a=>{await s(a,1),r++,n&&(n.textContent=`${r}/${i.length} models`)})),t.style.transition="opacity 320ms ease-out",requestAnimationFrame(()=>{t.style.opacity="0"}),setTimeout(()=>{t.remove(),e.remove()},360),this.showMainMenu(),this.loop()}collectUnknownPartIds(t){const e=[],n=i=>{for(const s of i)Pn(s.partId)||e.push(String(s.partId)),Array.isArray(s.children)&&n(s.children)};return n(t??[]),[...new Set(e)]}showMainMenu(){this.transitionTo(()=>{this.unmountCurrent(),this.sceneMgr.scene.background=new Rt(0);const t=a_()||o_()?()=>{const e=Dd();if(e){const i=this.collectUnknownPartIds(e.assembly);if(i.length>0){Xt.show(`Saved flight has unknown parts (${i.join(", ")}) — old save, starting fresh`,5e3),gh(),this.showFlight();return}for(const r of e.bodies){const a=this.system.bodies.find(l=>l.name===r.name);a&&(a.position=[...r.position],a.velocity=[...r.velocity],a.syncMesh?.())}const s=Pd(e.assembly);if(s){const r=new hr(s);this.showFlight(r,e);return}}const n=s_();if(n){const i=new hr(n);this.showFlight(i)}else this.showFlight()}:null;this.mainMenu=new $y(()=>this.showFlight(),()=>this.showVab(),()=>this.showSettings(),t??void 0,this.missions),this.mainMenu.mount()})}showSettings(){const t=new ev(tv(),()=>t.unmount());t.mount()}showVab(){this.transitionTo(()=>{this.unmountCurrent(),this.vab=new l_(t=>{const e=new hr(t);this.showFlight(e)},()=>this.showMainMenu()),this.vab.mount(),this.sceneMgr.scene.add(this.vab.scene)})}async showFlight(t,e){this.transitionTo(()=>{this.unmountCurrent(),e||gh();const n=t?.assembly??new uo;if(!t){const s=Re,r={S:1.4*s,M:2*s,L:2.8*s,XL:3.6*s},a=0;let l=-.18000000000000002/2;const c=_=>{const b=l+_/2;return l+=_+a,b},u=c(r.XL),h=c(r.XL),d=c(r.L),f=c(r.L),y=c(r.L),g=c(r.S),m=c(r.S),p=c(r.S),x=c(r.M);n.addRoot({part:Pn("engine_mammoth"),position:[0,u,0],rotation:0,children:[]}),n.addRoot({part:Pn("tank_xl_lfo"),position:[0,h,0],rotation:0,children:[]}),n.addRoot({part:Pn("decoupler_l"),position:[0,d,0],rotation:0,children:[]}),n.addRoot({part:Pn("engine_twinboar"),position:[0,f,0],rotation:0,children:[]}),n.addRoot({part:Pn("tank_l_lfo"),position:[0,y,0],rotation:0,children:[]}),n.addRoot({part:Pn("decoupler_s"),position:[0,g,0],rotation:0,children:[]}),n.addRoot({part:Pn("engine_sparkler"),position:[0,m,0],rotation:0,children:[]}),n.addRoot({part:Pn("tank_s_lfo"),position:[0,p,0],rotation:0,children:[]}),n.addRoot({part:Pn("capsule_mk1"),position:[0,x,0],rotation:0,children:[]})}const i=new hr(n);this.flight=new S_(this.renderer,this.sceneMgr,this.system,i,this.achievements,this.missions,e),this.flight.onCrashAction=s=>{s==="menu"?this.showMainMenu():this.showFlight(t)}})}transitionTo(t){const e=document.createElement("div");e.className="scene-fade fade-in",document.body.appendChild(e),setTimeout(()=>{t(),e.classList.remove("fade-in"),e.classList.add("fade-out"),setTimeout(()=>e.remove(),640)},280)}unmountCurrent(){this.mainMenu?.unmount(),this.mainMenu=void 0,this.vab&&(this.vab.unmount(),this.sceneMgr.scene.remove(this.vab.scene),this.vab=void 0),this.flight?.dispose(),this.flight=void 0}lastFrameTime=performance.now();loop(){const t=performance.now(),e=Math.min(Math.max((t-this.lastFrameTime)/1e3,5e-4),.05);this.lastFrameTime=t,this.sceneMgr.update(e),this.flight?.update(e),this.vab?this.renderer.three.render(this.vab.scene,this.vab.camera):this.renderer.three.render(this.sceneMgr.scene,this.sceneMgr.camera),requestAnimationFrame(()=>this.loop())}}function hv(){const o=document.getElementById("loading-screen");o&&o.classList.add("hidden");const t=document.getElementById("loading-label");t&&(t.dataset.done="1")}try{new cv().start()}catch(o){console.error("Failed to start Ellipse:",o),hv(),document.body.innerHTML+=`<div style="position:fixed;inset:0;z-index:950;color:white;padding:32px;font-family:monospace;background:#06080f;">
      <h1>Failed to start</h1>
      <pre>${String(o)}</pre>
    </div>`}
//# sourceMappingURL=index-D9ISVQw6.js.map
