...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function gc(){return new Pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:tl(),fragmentShader:`
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function _c(){return new Pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:tl(),fragmentShader:`
...
`)}function rg(o){return[o.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(xs).join(`
`)}function ag(o){const t=[];for(const e in o){const n=o[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function lg(o,t){const e={},n=o.getProgramParameter(t,o.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=o.getActiveAttrib(t,i),r=s.name;let a=1;s.type===o.FLOAT_MAT2&&(a=2),s.type===o.FLOAT_MAT3&&(a=3),s.type===o.FLOAT_MAT4&&(a=4),e[r]={type:s.type,location:o.getAttribLocation(t,r),locationSize:a}}return e}function xs(o){return o!==""}function wc(o,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return o.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Ac(o,t){return o.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const cg=/^[ \t]*#include +<([\w\d./]+)>/gm;function Fa(o){return o.replace(cg,ug)}const hg=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function ug(o,t){let e=Qt[t];if(e===void 0){const n=hg.get(t);if(n!==void 0)e=Qt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Fa(e)}const dg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Rc(o){return o.replace(dg,fg)}function fg(o,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Cc(o){let t="precision "+o.precision+` float;
precision `+o.precision+" int;";return o.precision==="highp"?t+=`
#define HIGH_PRECISION`:o.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:o.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function pg(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===vh?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===wu?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===Xn&&(t="SHADOWMAP_TYPE_VSM"),t}function mg(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case bs:case Ts:t="ENVMAP_TYPE_CUBE";break;case fr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function gg(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Ts:t="ENVMAP_MODE_REFRACTION";break}return t}function _g(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case qa:t="ENVMAP_BLENDING_MULTIPLY";break;case $u:t="ENVMAP_BLENDING_MIX";break;case Zu:t="ENVMAP_BLENDING_ADD";break}return t}function yg(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function xg(o,t,e,n){const i=o.getContext(),s=e.defines;let r=e.vertexShader,a=e.fragmentShader;const l=pg(e),c=mg(e),d=gg(e),h=_g(e),u=yg(e),f=e.isWebGL2?"":og(e),g=rg(e),_=ag(s),m=i.createProgram();let p,y,x=e.glslVersion?"#version "+e.glslVersion+`
`:"";e.isRawShaderMaterial?(p=["#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,_].filter(xs).join(`
`),p.length>0&&(p+=`
`),y=[f,"#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,_].filter(xs).join(`
`),y.length>0&&(y+=`
...
void main() {
    ...
    `,document.body.appendChild(n),this.crashOverlay=n,n.querySelector("#crash-menu").addEventListener("click",()=>{this.onCrashAction?.("menu")}),n.querySelector("#crash-restart").addEventListener("click",()=>{this.onCrashAction?.("restart")})}updateExplosion(t){if(this.explosionMeshes.length>0)for(let e=this.explosionMeshes.length-1;e>=0;e--){const n=this.explosionMeshes[e],i=n._age+t;n._age=i;const s=n._life,r=i/s;if(r>=1){this.sceneMgr.scene.remove(n),n.geometry.dispose(),n.material.dispose(),this.explosionMeshes.splice(e,1);continue}const a=n._shockRing,l=a?1+r*60:1+r*6;n.scale.setScalar(l);const c=s<1?2:1;n.material.opacity=a?Math.max(0,.85*(1-r*1.5)):Math.max(0,.9*(1-r*c)),n.position.x+=n._vx*t,n.position.y+=n._vy*t,n.position.z+=n._vz*t}}explosionMeshes=[];spawnExplosion(t,e,n){const i=[16746496,16729088,16720384,16737792,13386752,16755200],s=new mt(new ue(.8,12,8),new we({color:16755200,transparent:!0,opacity:1,blending:an,depthWrite:!1}));s.position.set(t,e,n),s._life=.8,s._age=0,this.sceneMgr.scene.add(s),this.explosionMeshes.push(s);for(let r=0;r<8;r++){const a=1+Math.random()*1.5,l=new ue(a,8,6),c=new we({color:i[r%i.length],transparent:!0,opacity:.9,blending:an,depthWrite:!1}),d=new mt(l,c),h=r/8*Math.PI*2,u=Math.random()*Math.PI,f=.3;d.position.set(t+Math.sin(h)*Math.cos(u)*f,e+Math.sin(u)*f,n+Math.cos(h)*Math.cos(u)*f),d._life=1.5+Math.random()*.5,d._age=0,d._vx=Math.sin(h)*Math.cos(u)*(1+Math.random()*3),d._vy=Math.sin(u)*(1+Math.random()*3),d._vz=Math.cos(h)*Math.cos(u)*(1+Math.random()*3),this.sceneMgr.scene.add(d),this.explosionMeshes.push(d)}for(let r=0;r<4;r++){const a=1.5+Math.random()*2,l=new we({color:4473924,transparent:!0,opacity:.4,blending:mi,depthWrite:!1}),c=new mt(new ue(a,6,6),l),d=r/4*Math.PI*2+Math.random()*.5;c.position.set(t+Math.cos(d)*.5,e+(Math.random()-.5)*.3,n+Math.sin(d)*.5),c._life=2+Math.random()*.5,c._age=0,c._vx=Math.cos(d)*(.5+Math.random()*1.5),c._vy=(Math.random()-.5)*1,c._vz=Math.sin(d)*(.5+Math.random()*1.5),this.sceneMgr.scene.add(c),this.explosionMeshes.push(c)}}spawnShockRing(t=16777215){const e=new C;this.rocketGroup.getWorldPosition(e),e.x*Nt,e.y*Nt,e.z*Nt;const n=new Xi(.1,.2,64),i=new we({color:t,transparent:!0,opacity:.85,side:He,blending:an,depthWrite:!1}),s=new mt(n,i);s.position.set(this.rocketGroup.position.x,this.rocketGroup.position.y,this.rocketGroup.position.z),s.quaternion.copy(this.rocketQuat),s.scale.setScalar(1),s._life=1.2,s._age=0,s._shockRing=!0,s._vx=0,s._vy=0,s._vz=0,this.sceneMgr.scene.add(s),this.explosionMeshes.push(s)}hasLandingLegs(){const t=e=>{for(const n of e)if(n.part.kind==="legs"||t(n.children))return!0;return!1};return t(this.rocket.assembly.roots)}positionFlameAtNozzle(){let t=1/0,e=-1/0;this.rocketGroup.traverse(i=>{if(i instanceof mt){if(this.gearMeshes.includes(i)||i===this.rocketShadow||i===this.reentryGlow||i===this.reentryGlowMesh)return;const s=new bn().setFromObject(i);s.min.y<t&&(t=s.min.y),s.max.y>e&&(e=s.max.y)}}),this.rocketBottomY=t===1/0?-.1:t;const n=t===1/0?-.1:t-.01;this.engineFlame.getMesh().position.set(0,n,0),this.engineFlame.getMesh().rotation.set(0,0,0)}dispose(){this.crashOverlay&&(this.crashOverlay.remove(),this.crashOverlay=null),this.sceneMgr.scene.remove(this.rocketGroup);for(const t of this.debris)this.sceneMgr.scene.remove(t.mesh);this.debris=[];for(const t of this.explosionMeshes)this.sceneMgr.scene.remove(t),t.geometry.dispose(),t.material.dispose();this.explosionMeshes=[],this.controls.dispose(),this.chase.dispose(),this.engineFlame.dispose(),this.groundSmoke.dispose(),this.hud.unmount(),this.sound.dispose()}}function nx(o,t,e){const n=o.mass,i=[...o.position],s=[...o.velocity],r=ke(t(o),1/n),a=s,c=ma(o,Ke(i,ke(r,.5*e)),Ke(s,ke(a,.5*e))),d=ke(t(c),1/n),h=Ke(s,ke(r,.5*e)),f=ma(o,Ke(i,ke(d,.5*e)),Ke(s,ke(h,.5*e))),g=ke(t(f),1/n),_=Ke(s,ke(d,.5*e)),p=ma(o,Ke(i,ke(g,e)),Ke(s,ke(_,e))),y=ke(t(p),1/n),x=Ke(s,ke(g,e)),b=ke(Ke(Ke(r,ke(d,2)),Ke(ke(g,2),y)),e/6),R=ke(Ke(Ke(a,ke(h,2)),Ke(ke(_,2),x)),e/6);o.position=Ke(i,R),o.velocity=Ke(s,b)}function ma(o,t,e){return{...o,position:t,velocity:e}}function Ke(o,t){return[o[0]+t[0],o[1]+t[1],o[2]+t[2]]}function ke(o,t){return[o[0]*t,o[1]*t,o[2]*t]}class ix{bodies=[];add(t){this.bodies.push(t)}bodyByName(t){return this.bodies.find(e=>e.name===t)}propagate(t,e){let n=t;for(;n>0;){const i=Math.min(e,n);this.step(i),n-=i}}step(t){for(const e of this.bodies){if(e.mass<=0)continue;const n=_u(e,this.bodies);nx(e,()=>n,t)}}}const oi=un*dn;class On extends ll{radius;visualRadius;mesh;constructor(t,e,n,i,s){super(t,e,n,i),this.radius=s,this.visualRadius=s*oi;const r=new ue(this.visualRadius,64,32),a=new fe({color:8421504});this.mesh=new mt(r,a),this.mesh.position.set(n[0]*oi,n[1]*oi,n[2]*oi)}getTerrainHeightVisual(t,e,n){return 0}syncMesh(){this.mesh.position.set(this.position[0]*oi,this.position[1]*oi,this.position[2]*oi)}getSurfaceRadiusAt(t){const e=t[0]-this.position[0],n=t[1]-this.position[1],i=t[2]-this.position[2],s=Math.sqrt(e*e+n*n+i*i);if(s===0)return this.radius;const r=e/s,a=n/s,l=i/s,d=this.getTerrainHeightVisual(r,a,l)/oi;return this.radius+d}}const ga=un*dn,hh=64,ri=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},sx=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),d=a*a*(3-2*a),h=l*l*(3-2*l),u=ri(n,i,s),f=ri(n+1,i,s),g=ri(n,i+1,s),_=ri(n+1,i+1,s),m=ri(n,i,s+1),p=ri(n+1,i,s+1),y=ri(n,i+1,s+1),x=ri(n+1,i+1,s+1);return Li(Li(Li(u,f,c),Li(g,_,c),d),Li(Li(m,p,c),Li(y,x,c),d),h)},jo=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*sx(o*l,t*l,e*l),r+=s,s*=.5}return i/r},Li=(o,t,e)=>o+(t-o)*e;class ox extends On{getTerrainHeightVisual(t,e,n){const i=jo(t*10+500,e*10+600,n*10+700,4),s=jo(t*40+100,e*40+200,n*40+300,3),r=i*.8+s*.2,a=this.visualRadius*.03;return r>.4?((r-.4)/.6)**2*a:-(.4-r)/.4*a*.12}constructor(t,e){super("mercury",1e24,t,e,244e4);const n=this.visualRadius,s=new Fs().load(Os("/textures/mercury.jpg"),h=>{h.colorSpace=ee,h.anisotropy=4}),r=new ue(n,hh,hh),a=r.attributes.position,l=new C,c=n*.03;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const u=l.x/n,f=l.y/n,g=l.z/n,_=jo(u*10+500,f*10+600,g*10+700,4),m=jo(u*40+100,f*40+200,g*40+300,3),p=_*.8+m*.2;let y=0;p>.4?y=((p-.4)/.6)**2*c:y=-(.4-p)/.4*c*.12,l.setLength(n+y),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const d=new fe({map:s,roughness:.9,metalness:0,color:16777215});this.mesh=new mt(r,d),this.mesh.position.set(t[0]*ga,t[1]*ga,t[2]*ga)}}const uh=`
...
`;class Yi{group=new sn;innerMesh;outerMesh;innerMat;outerMat;constructor(t,e=4491519,n=.7,i,s=16737826,r=3){const a=new Tt(e),l=new Tt(s),c=i??t*.08,d=new C(0,0,0),h=t*1.01,u=new ue(h,64,48);this.innerMat=new Pn({vertexShader:uh,fragmentShader:rx,uniforms:{uSunDir:{value:new C(0,1,0)},uPlanetCenter:{value:d},uInnerRadius:{value:t},uAtmHeight:{value:c},uRayleighCol:{value:a},uMieCol:{value:new Tt(.9,.9,1)},uDensity:{value:n},uTerminatorCol:{value:l},uGlowPower:{value:r}},transparent:!0,blending:an,depthWrite:!1,side:Cn}),this.innerMesh=new mt(u,this.innerMat),this.group.add(this.innerMesh);const f=t*1.06,g=new ue(f,48,32);this.outerMat=new Pn({vertexShader:uh,fragmentShader:ax,uniforms:{uSunDir:{value:new C(0,1,0)},uPlanetCenter:{value:d},uInnerRadius:{value:t},uDensity:{value:n*.5},uGlowPower:{value:r}},transparent:!0,blending:an,depthWrite:!1,side:Cn}),this.outerMesh=new mt(g,this.outerMat),this.group.add(this.outerMesh)}setSunDirection(t,e){const n=new C().copy(t).sub(e).normalize();this.innerMat.uniforms.uSunDir.value.copy(n),this.outerMat.uniforms.uSunDir.value.copy(n)}getMesh(){return this.group}dispose(){this.innerMat.dispose(),this.outerMat.dispose(),this.innerMesh.geometry.dispose(),this.outerMesh.geometry.dispose()}}const _a=un*dn,dh=64,ai=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},lx=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),d=a*a*(3-2*a),h=l*l*(3-2*l),u=ai(n,i,s),f=ai(n+1,i,s),g=ai(n,i+1,s),_=ai(n+1,i+1,s),m=ai(n,i,s+1),p=ai(n+1,i,s+1),y=ai(n,i+1,s+1),x=ai(n+1,i+1,s+1);return Ii(Ii(Ii(u,f,c),Ii(g,_,c),d),Ii(Ii(m,p,c),Ii(y,x,c),d),h)},$o=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*lx(o*l,t*l,e*l),r+=s,s*=.5}return i/r},Ii=(o,t,e)=>o+(t-o)*e;class cx extends On{getTerrainHeightVisual(t,e,n){const i=$o(t*6+50,e*6+100,n*6+150,4),s=$o(t*15+200,e*15+300,n*15+400,3),r=i*.6+s*.4,a=this.visualRadius*.015;return r>.35?((r-.35)/.65)**2*a:-(.35-r)/.35*a*.05}atmosphereGlow;constructor(t,e){super("venus",146e23,t,e,6052e3);const n=this.visualRadius,s=new Fs().load(Os("/textures/venus.jpg"),h=>{h.colorSpace=ee,h.anisotropy=4}),r=new ue(n,dh,dh),a=r.attributes.position,l=new C,c=n*.015;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const u=l.x/n,f=l.y/n,g=l.z/n,_=$o(u*6+50,f*6+100,g*6+150,4),m=$o(u*15+200,f*15+300,g*15+400,3),p=_*.6+m*.4;let y=0;p>.35?y=((p-.35)/.65)**2*c:y=-(.35-p)/.35*c*.05,l.setLength(n+y),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const d=new fe({map:s,roughness:.9,metalness:0,color:16777215});this.mesh=new mt(r,d),this.mesh.position.set(t[0]*_a,t[1]*_a,t[2]*_a),this.atmosphereGlow=new Yi(n,15247436,.4),this.mesh.add(this.atmosphereGlow.getMesh())}}const ya=un*dn;class hx extends On{constructor(t,e){super("pluto",44e20,t,e,1188e3);const n=new ue(this.visualRadius,32,16),i=new fe({color:14535867,roughness:.9,metalness:0});this.mesh=new mt(n,i),this.mesh.position.set(t[0]*ya,t[1]*ya,t[2]*ya)}}const xa=un*dn;function yu(o){let t=o|0;return()=>{t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function ux(){const e=document.createElement("canvas");e.width=2048,e.height=1024;const n=e.getContext("2d"),i=n.createImageData(2048,1024),s=3;for(let a=0;a<1024;a++)for(let l=0;l<2048;l++){const c=l/2048,d=a/1024,h=(d-.5)*Math.PI,u=c*Math.PI*2,f=Math.cos(h)*Math.cos(u),g=Math.cos(h)*Math.sin(u),_=Math.sin(h),m=Math.sin(f*s+g*1.3+_*.7)*.5+.5,p=Math.sin((f+1.7)*s*2+_*1.1)*.5+.5,y=Math.cos((g+.5)*s*4-f*2.3)*.5+.5,x=Math.sin(f*s*8+g*6+_*7)*.5+.5;let b=m*.4+p*.3+y*.2+x*.1;const R=1-Math.abs(d-.5)*1.2;b*=Math.max(0,R),b=Math.max(0,(b-.4)*2.5);const A=Math.min(255,Math.max(0,Math.round(b*255))),T=(a*2048+l)*4;i.data[T]=A,i.data[T+1]=A,i.data[T+2]=A,i.data[T+3]=255}n.putImageData(i,0,0);const r=new Be(e);return r.wrapS=r.wrapT=Ue,r}function dx(){const e=document.createElement("canvas");e.width=2048,e.height=1024;const n=e.getContext("2d");n.fillStyle="#000000",n.fillRect(0,0,2048,1024);const i=[{lat:.7,lon:-1.8,rx:.5,ry:.8},{lat:-.4,lon:-1.3,rx:.6,ry:.35},{lat:.85,lon:.4,rx:.25,ry:.3},{lat:.1,lon:.6,rx:.55,ry:.4},{lat:.7,lon:1.6,rx:.55,ry:1},{lat:-.6,lon:2.4,rx:.25,ry:.3},{lat:1.1,lon:-.9,rx:.2,ry:.2}],s=yu(42);for(const a of i){const l=(a.lon+Math.PI)/(2*Math.PI)*2048,c=(Math.PI/2-a.lat)/Math.PI*1024,d=a.rx/(2*Math.PI)*2048,h=a.ry/Math.PI*1024,u=20+Math.floor(s()*40);for(let f=0;f<u;f++){const g=(s()-.5)*d*2,_=(s()-.5)*h*2;if((g/d)**2+(_/h)**2>1)continue;const p=l+g,y=c+_,x=1+s()*4,b=100+Math.floor(s()*155);n.fillStyle=`rgb(${b}, ${Math.floor(b*.85)}, ${Math.floor(b*.5)})`,n.beginPath(),n.arc(p,y,x,0,Math.PI*2),n.fill(),n.fillStyle=`rgba(255, 220, 100, ${.05+s()*.1})`,n.beginPath(),n.arc(p,y,x*3,0,Math.PI*2),n.fill()}for(let f=0;f<3;f++){const g=(s()-.5)*d*1.5,_=(s()-.5)*h*1.5;if((g/d)**2+(_/h)**2>1)continue;const p=l+g,y=c+_;n.fillStyle="#ffdd66",n.beginPath(),n.arc(p,y,3+s()*5,0,Math.PI*2),n.fill(),n.fillStyle="rgba(255, 200, 80, 0.2)",n.beginPath(),n.arc(p,y,8+s()*10,0,Math.PI*2),n.fill()}}for(const a of i){const l=(a.lon+Math.PI)/(2*Math.PI)*2048,c=(Math.PI/2-a.lat)/Math.PI*1024,d=a.rx/(2*Math.PI)*2048,h=a.ry/Math.PI*1024;for(let u=0;u<30;u++){const f=s()*Math.PI*2,g=.85+s()*.2,_=l+Math.cos(f)*d*g,m=c+Math.sin(f)*h*g,p=1+s()*2;n.fillStyle=`rgba(200, 180, 100, ${.1+s()*.15})`,n.beginPath(),n.arc(_,m,p,0,Math.PI*2),n.fill()}}const r=new Be(e);return r.wrapS=r.wrapT=Ue,r.colorSpace=ee,r}function fx(){const e=document.createElement("canvas");e.width=2048,e.height=1024;const n=e.getContext("2d"),i=n.createImageData(2048,1024),s=i.data,r=[{lat:.7,lon:-1.8,rx:.5,ry:.8},{lat:-.4,lon:-1.3,rx:.6,ry:.35},{lat:.85,lon:.4,rx:.25,ry:.3},{lat:.1,lon:.6,rx:.55,ry:.4},{lat:.7,lon:1.6,rx:.55,ry:1},{lat:-.6,lon:2.4,rx:.25,ry:.3},{lat:1.1,lon:-.9,rx:.2,ry:.2}];for(let l=0;l<1024;l++)for(let c=0;c<2048;c++){const d=c/2048,u=(l/1024-.5)*Math.PI,f=d*Math.PI*2-Math.PI;let g=!1;for(const p of r){const y=(u-p.lat)/p.rx,x=(f-p.lon)/p.ry;if(y*y+x*x<1){g=!0;break}}const _=g?180:40,m=(l*2048+c)*4;s[m]=s[m+1]=s[m+2]=_,s[m+3]=255}n.putImageData(i,0,0);const a=new Be(e);return a.wrapS=a.wrapT=Ue,a}function px(){const e=document.createElement("canvas");e.width=2048,e.height=1024;const n=e.getContext("2d"),i=n.createLinearGradient(0,0,0,1024);i.addColorStop(0,"#2255aa"),i.addColorStop(.5,"#3399ee"),i.addColorStop(1,"#2255aa"),n.fillStyle=i,n.fillRect(0,0,2048,1024);const s=[{lat:.7,lon:-2,rx:.55,ry:.5,color:"#4a8c2a"},{lat:.65,lon:-1.6,rx:.35,ry:.35,color:"#5a9c3a"},{lat:-.35,lon:-1.4,rx:.4,ry:.6,color:"#5a9c3a"},{lat:.85,lon:.4,rx:.2,ry:.22,color:"#6aac4a"},{lat:.1,lon:.6,rx:.45,ry:.5,color:"#7a8c3a"},{lat:.5,lon:1.5,rx:.6,ry:.4,color:"#6a9c3a"},{lat:.3,lon:1.1,rx:.25,ry:.15,color:"#7aac4a"},{lat:-.4,lon:1.7,rx:.15,ry:.35,color:"#5a9c3a"},{lat:1,lon:-2.5,rx:.08,ry:.1,color:"#5a9c3a"},{lat:-.7,lon:-1.1,rx:.08,ry:.08,color:"#6aac4a"}];for(const a of s){n.fillStyle=a.color,n.beginPath();const l=(a.lon+Math.PI)/(2*Math.PI)*2048,c=(Math.PI/2-a.lat)/Math.PI*1024,d=a.rx/(2*Math.PI)*2048,h=a.ry/Math.PI*1024;n.ellipse(l,c,d,h,0,0,Math.PI*2),n.fill();const u=a.lat*1e3+a.lon*100,f=yu(u);for(let g=0;g<80;g++){const _=(f()-.5)*d*1.8,m=(f()-.5)*h*1.8;(_/d)**2+(m/h)**2<1&&(n.fillStyle=f()>.5?"#2a5c1f":"#6a9c4a",n.beginPath(),n.arc(l+_,c+m,1+f()*4,0,Math.PI*2),n.fill())}}n.fillStyle="#c0d8e8",n.fillRect(0,0,2048,1024*.05),n.fillRect(0,1024*.95,2048,1024*.05);const r=new Be(e);return r.wrapS=r.wrapT=Ue,r.colorSpace=ee,r}class mx extends On{atmosphereGlow;cloudMesh;cloudTex;constructor(t,e){super("earth",my,t,e,6371e3);const n=this.visualRadius,i=256,s=new ue(n,i,i),r=fx(),a=new fe({roughness:.7,roughnessMap:r,metalness:0,bumpMap:vy(),bumpScale:.3,emissiveMap:dx(),emissive:new Tt(16768358),emissiveIntensity:.6,polygonOffset:!0,polygonOffsetFactor:1,polygonOffsetUnits:1});this.mesh=new mt(s,a),this.mesh.position.set(t[0]*xa,t[1]*xa,t[2]*xa),this.generateTerrain(n);const l=px();l.minFilter=yi,l.magFilter=De,l.generateMipmaps=!1,l.colorSpace=ee,a.map=l,a.needsUpdate=!0;const c=[l,r,a.bumpMap,a.emissiveMap].filter(Boolean);for(const u of c)u.minFilter=De,u.magFilter=De,u.generateMipmaps=!1,u.needsUpdate=!0;this.loadHighResTexture().catch(()=>{}),this.atmosphereGlow=new Yi(n,4491519,2.5,n*.1),this.mesh.add(this.atmosphereGlow.getMesh()),this.cloudTex=ux();const d=new fe({map:this.cloudTex,transparent:!0,opacity:.35,depthWrite:!1,side:He,roughness:1,metalness:0}),h=new ue(n*1.008,i,i);this.cloudMesh=new mt(h,d),this.cloudMesh.position.copy(this.mesh.position),this.mesh.add(this.cloudMesh)}async loadHighResTexture(){try{const e=await new Fs().loadAsync(Os("/textures/earth_daymap.jpg"));e.colorSpace=ee,e.anisotropy=16,e.minFilter=De,e.magFilter=De,e.generateMipmaps=!1;const n=this.mesh.material;n.map=e,n.needsUpdate=!0,console.log("Earth high-res texture loaded")}catch(t){console.warn("Earth texture load failed, using fallback:",t)}}updateClouds(t,e){if(this.cloudMesh.rotation.y+=t*.012,!e)return;const n=this.mesh.material,i=Math.sqrt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2])||1,s=e[0]/i,r=e[1]/i,a=e[2]/i;this.mesh.lookAt(this.mesh.position.x+s*100,this.mesh.position.y+r*100,this.mesh.position.z+a*100),this.mesh.position.x,this.mesh.position.y,this.mesh.position.z,n.emissiveIntensity=.15}getTerrainHeightVisual(t,e,n){const i=Math.sin(t*5+e*3)*.5+Math.cos(e*4-n*3)*.3,s=Math.sin(n*6+t*2+e*4)*.15+Math.sin(t*12+e*8+n*10)*.1,r=Math.sin(t*20+n*15)*.05+Math.cos(e*18+t*12)*.04,a=Math.sin(t*40+e*35+n*45)*.02,l=((i+s+r+a)*.35+.5)*1.1,c=this.visualRadius*.025,d=this.visualRadius*.006;if(l>.45){const h=(l-.45)/.55;return(h<.7?h*.5:.35+(h-.7)/.3*.65)*c}if(l>.35){const h=(l-.35)/.1;return h*h*c*.3}return-(.35-l)/.35*d}generateTerrain(t){const e=this.mesh.geometry,n=e.attributes.position,i=new C;for(let s=0;s<n.count;s++){i.fromBufferAttribute(n,s);const r=i.x/t,a=i.y/t,l=i.z/t,c=this.getTerrainHeightVisual(r,a,l);i.setLength(t+c),n.setXYZ(s,i.x,i.y,i.z)}n.needsUpdate=!0,e.computeVertexNormals()}}const va=un*dn,fh=64,li=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},gx=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),d=a*a*(3-2*a),h=l*l*(3-2*l),u=li(n,i,s),f=li(n+1,i,s),g=li(n,i+1,s),_=li(n+1,i+1,s),m=li(n,i,s+1),p=li(n+1,i,s+1),y=li(n,i+1,s+1),x=li(n+1,i+1,s+1);return Di(Di(Di(u,f,c),Di(g,_,c),d),Di(Di(m,p,c),Di(y,x,c),d),h)},Zo=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*gx(o*l,t*l,e*l),r+=s,s*=.5}return i/r},Di=(o,t,e)=>o+(t-o)*e;class _x extends On{getTerrainHeightVisual(t,e,n){const i=Zo(t*8+100,e*8+200,n*8+300,4),s=Zo(t*30+400,e*30+500,n*30+600,3),r=i*.7+s*.3,a=this.visualRadius*.04;return r>.45?((r-.45)/.55)**2*a:-(.45-r)/.45*a*.15}constructor(t,e){super("moon",22e22,t,e,1737e3);const n=this.visualRadius,s=new Fs().load(Os("/textures/moon.jpg"),h=>{h.colorSpace=ee,h.anisotropy=4}),r=new ue(n,fh,fh),a=r.attributes.position,l=new C,c=n*.04;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const u=l.x/n,f=l.y/n,g=l.z/n,_=Zo(u*8+100,f*8+200,g*8+300,4),m=Zo(u*30+400,f*30+500,g*30+600,3),p=_*.7+m*.3;let y=0;p>.45?y=((p-.45)/.55)**2*c:y=-(.45-p)/.45*c*.15,l.setLength(n+y),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const d=new fe({map:s,roughness:.95,metalness:0,color:16777215});this.mesh=new mt(r,d),this.mesh.position.set(t[0]*va,t[1]*va,t[2]*va)}}const Ma=un*dn,ph=64,ci=(o,t,e)=>{const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)},yx=(o,t,e)=>{const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),d=a*a*(3-2*a),h=l*l*(3-2*l),u=ci(n,i,s),f=ci(n+1,i,s),g=ci(n,i+1,s),_=ci(n+1,i+1,s),m=ci(n,i,s+1),p=ci(n+1,i,s+1),y=ci(n,i+1,s+1),x=ci(n+1,i+1,s+1);return Ui(Ui(Ui(u,f,c),Ui(g,_,c),d),Ui(Ui(m,p,c),Ui(y,x,c),d),h)},Jo=(o,t,e,n)=>{let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*yx(o*l,t*l,e*l),r+=s,s*=.5}return i/r},Ui=(o,t,e)=>o+(t-o)*e;class xx extends On{getTerrainHeightVisual(t,e,n){const i=Jo(t*4+10,e*4+20,n*4+30,5),s=Jo(t*20+100,e*20+200,n*20+300,3),r=i*.7+s*.3,a=this.visualRadius*.035;return r>.4?((r-.4)/.6)**2*a:-(.4-r)/.4*a*.1}atmosphereGlow;constructor(t,e){super("mars",19e23,t,e,339e4);const n=this.visualRadius,s=new Fs().load(Os("/textures/mars.jpg"),h=>{h.colorSpace=ee,h.anisotropy=4}),r=new ue(n,ph,ph),a=r.attributes.position,l=new C,c=n*.035;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const u=l.x/n,f=l.y/n,g=l.z/n,_=Jo(u*4+10,f*4+20,g*4+30,5),m=Jo(u*20+100,f*20+200,g*20+300,3),p=_*.7+m*.3;let y=0;p>.4?y=((p-.4)/.6)**2*c:y=-(.4-p)/.4*c*.1,l.setLength(n+y),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,r.computeVertexNormals();const d=new fe({map:s,roughness:.85,metalness:0,color:16777215});this.mesh=new mt(r,d),this.mesh.position.set(t[0]*Ma,t[1]*Ma,t[2]*Ma),this.atmosphereGlow=new Yi(n,13920842,.25),this.mesh.add(this.atmosphereGlow.getMesh())}}function hi(o,t,e){const n=Math.sin(o*127.1+t*311.7+e*74.9)*43758.5453;return n-Math.floor(n)}function vx(o,t,e){const n=Math.floor(o),i=Math.floor(t),s=Math.floor(e),r=o-n,a=t-i,l=e-s,c=r*r*(3-2*r),d=a*a*(3-2*a),h=l*l*(3-2*l),u=hi(n,i,s),f=hi(n+1,i,s),g=hi(n,i+1,s),_=hi(n+1,i+1,s),m=hi(n,i,s+1),p=hi(n+1,i,s+1),y=hi(n,i+1,s+1),x=hi(n+1,i+1,s+1);return Ni(Ni(Ni(u,f,c),Ni(g,_,c),d),Ni(Ni(m,p,c),Ni(y,x,c),d),h)}function xi(o,t,e,n){let i=0,s=1,r=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*vx(o*l,t*l,e*l),r+=s,s*=.5}return i/r}function Ni(o,t,e){return o+(t-o)*e}const Sa=un*dn,mh=64;class Mx extends On{atmosphereGlow;constructor(t,e){super("jupiter",19e26,t,e,69911e3);const n=this.visualRadius,i=Ry(),s=new ue(n,mh,mh),r=s.attributes.position,a=new C,l=n*.02;for(let d=0;d<r.count;d++){a.fromBufferAttribute(r,d);const h=a.x/n,u=a.y/n,f=a.z/n,g=xi(h*8+10,u*8+20,f*8+30,4),_=xi(h*30+100,u*30+200,f*30+300,3),m=g*.7+_*.3;let p=0;m>.4?p=((m-.4)/.6)**2*l:p=-(.4-m)/.4*l*.1,a.setLength(n+p),r.setXYZ(d,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new fe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new mt(s,c),this.mesh.position.set(t[0]*Sa,t[1]*Sa,t[2]*Sa),this.mesh.rotation.z=3.1*Math.PI/180,this.atmosphereGlow=new Yi(n,13935988,.15),this.mesh.add(this.atmosphereGlow.getMesh())}}const ba=un*dn;function Sx(){const e=document.createElement("canvas");e.width=1024,e.height=64;const n=e.getContext("2d"),i=n.createLinearGradient(0,0,1024,0);i.addColorStop(0,"#8a7a5a"),i.addColorStop(.05,"#b8a888"),i.addColorStop(.12,"#d4c8a8"),i.addColorStop(.2,"#c0b898"),i.addColorStop(.35,"#e8ddd0"),i.addColorStop(.5,"#c0b090"),i.addColorStop(.65,"#d8ccb0"),i.addColorStop(.8,"#a89878"),i.addColorStop(.9,"#786858"),i.addColorStop(1,"#584838"),n.fillStyle=i,n.fillRect(0,0,1024,64);for(let r=0;r<8e3;r++){const a=Math.random()*1024,l=Math.random()*64,c=1+Math.random()*4,d=120+Math.random()*80;n.fillStyle=`rgba(${d},${d-20},${d-40},${.2+Math.random()*.4})`,n.beginPath(),n.arc(a,l,c,0,Math.PI*2),n.fill()}n.fillStyle="rgba(0,0,0,0.7)",n.fillRect(1024*.43,0,1024*.04,64),n.fillStyle="rgba(0,0,0,0.4)",n.fillRect(1024*.72,0,1024*.015,64),n.fillStyle="rgba(0,0,0,0.3)",n.fillRect(1024*.1,0,1024*.02,64),n.fillRect(1024*.17,0,1024*.01,64),n.fillRect(1024*.55,0,1024*.02,64),n.fillStyle="rgba(200,190,170,0.15)";for(let r=0;r<1024;r+=8)n.fillRect(r,0,2,64);const s=new Be(e);return s.wrapS=Ue,s.wrapT=Ue,s.anisotropy=4,s}class bx extends On{atmosphereGlow;constructor(t,e){super("saturn",5683e23,t,e,58232e3);const n=this.visualRadius,i=Cy(),s=new ue(n,64,32),r=s.attributes.position,a=new C,l=n*.015;for(let p=0;p<r.count;p++){a.fromBufferAttribute(r,p);const y=a.x/n,x=a.y/n,b=a.z/n,R=xi(y*8+10,x*8+20,b*8+30,4),A=xi(y*30+100,x*30+200,b*30+300,3),T=R*.7+A*.3;let F=0;T>.4?F=((T-.4)/.6)**2*l:F=-(.4-T)/.4*l*.1,a.setLength(n+F),r.setXYZ(p,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new fe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new mt(s,c),this.mesh.position.set(t[0]*ba,t[1]*ba,t[2]*ba),this.mesh.rotation.z=26.7*Math.PI/180,this.atmosphereGlow=new Yi(n,16049313,.1),this.mesh.add(this.atmosphereGlow.getMesh());const d=Sx(),h=new Xi(n*1.15,n*2.4,256),u=new we({map:d,side:He,transparent:!0,opacity:.8,depthWrite:!1}),f=new mt(h,u);f.rotation.x=-Math.PI/2,f.rotation.z=26.7*Math.PI/180,this.mesh.add(f);const g=new Xi(n*2.4,n*2.8,128),_=new we({color:8943720,side:He,transparent:!0,opacity:.15,depthWrite:!1}),m=new mt(g,_);m.rotation.x=-Math.PI/2,m.rotation.z=26.7*Math.PI/180,this.mesh.add(m)}}const Ta=un*dn;class Tx extends On{atmosphereGlow;constructor(t,e){super("uranus",8681e22,t,e,25362e3);const n=this.visualRadius,i=Py(),s=new ue(n,64,32),r=s.attributes.position,a=new C,l=n*.015;for(let f=0;f<r.count;f++){a.fromBufferAttribute(r,f);const g=a.x/n,_=a.y/n,m=a.z/n,p=xi(g*6+10,_*6+20,m*6+30,4),y=xi(g*25+400,_*25+500,m*25+600,3),x=p*.7+y*.3;let b=0;x>.4?b=((x-.4)/.6)**2*l:b=-(.4-x)/.4*l*.1,a.setLength(n+b),r.setXYZ(f,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new fe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new mt(s,c),this.mesh.position.set(t[0]*Ta,t[1]*Ta,t[2]*Ta),this.mesh.rotation.z=-97.8*Math.PI/180,this.atmosphereGlow=new Yi(n,5230824,.1),this.mesh.add(this.atmosphereGlow.getMesh());const d=new Xi(n*1.2,n*2.1,64),h=new we({color:11184844,side:He,transparent:!0,opacity:.3}),u=new mt(d,h);u.rotation.x=-Math.PI/2,u.rotation.z=97.8*Math.PI/180,this.mesh.add(u)}}const Ea=un*dn;class Ex extends On{atmosphereGlow;constructor(t,e){super("neptune",1024e23,t,e,24622e3);const n=this.visualRadius,i=Ly(),s=new ue(n,64,32),r=s.attributes.position,a=new C,l=n*.015;for(let d=0;d<r.count;d++){a.fromBufferAttribute(r,d);const h=a.x/n,u=a.y/n,f=a.z/n,g=xi(h*6+10,u*6+20,f*6+30,4),_=xi(h*25+100,u*25+200,f*25+300,3),m=g*.7+_*.3;let p=0;m>.4?p=((m-.4)/.6)**2*l:p=-(.4-m)/.4*l*.1,a.setLength(n+p),r.setXYZ(d,a.x,a.y,a.z)}r.needsUpdate=!0,s.computeVertexNormals();const c=new fe({map:i,roughness:.9,metalness:0,color:16777215});this.mesh=new mt(s,c),this.mesh.position.set(t[0]*Ea,t[1]*Ea,t[2]*Ea),this.mesh.rotation.z=28.3*Math.PI/180,this.atmosphereGlow=new Yi(n,4944093,.15),this.mesh.add(this.atmosphereGlow.getMesh())}}const _s=un*dn,wx=`
varying vec2 vUv;
void main() {
  vUv = uv;
