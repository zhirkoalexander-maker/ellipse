...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ii,depthTest:!1,depthWrite:!1})}function ec(){return new vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ia(),fragmentShader:`
		...
		`,blending:ii,depthTest:!1,depthWrite:!1})}function tc(){return new vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ia(),fragmentShader:`
...
`].filter(us).join(`
`)),o=ga(o),o=hc(o,t),o=uc(o,t),a=ga(a),a=hc(a,t),a=uc(a,t),o=dc(o),a=dc(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(x=`#version 300 es
...
`,$v=1.04;class Hi{mesh;constructor(e,t=4491519,n=.7){const i=e*$v,s=new ht(i,48,24),o=new vn({vertexShader:Yv,fragmentShader:jv,uniforms:{glowColor:{value:new Te(t)},intensity:{value:n}},transparent:!0,blending:Nn,depthWrite:!1,side:_n});this.mesh=new _e(s,o)}getMesh(){return this.mesh}}const na=On*kn,Kc=64,$n=(r,e,t)=>{const n=Math.sin(r*127.1+e*311.7+t*74.9)*43758.5453;return n-Math.floor(n)},Kv=(r,e,t)=>{const n=Math.floor(r),i=Math.floor(e),s=Math.floor(t),o=r-n,a=e-i,l=t-s,c=o*o*(3-2*o),d=a*a*(3-2*a),h=l*l*(3-2*l),u=$n(n,i,s),f=$n(n+1,i,s),g=$n(n,i+1,s),_=$n(n+1,i+1,s),m=$n(n,i,s+1),p=$n(n+1,i,s+1),v=$n(n,i+1,s+1),x=$n(n+1,i+1,s+1);return xi(xi(xi(u,f,c),xi(g,_,c),d),xi(xi(m,p,c),xi(v,x,c),d),h)},Fr=(r,e,t,n)=>{let i=0,s=1,o=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*Kv(r*l,e*l,t*l),o+=s,s*=.5}return i/o},xi=(r,e,t)=>r+(e-r)*t;class Zv extends Hn{getTerrainHeightVisual(e,t,n){const i=Fr(e*6+50,t*6+100,n*6+150,4),s=Fr(e*15+200,t*15+300,n*15+400,3),o=i*.6+s*.4,a=this.visualRadius*.015;return o>.35?((o-.35)/.65)**2*a:-(.35-o)/.35*a*.05}atmosphereGlow;constructor(e,t){super("venus",146e23,e,t,6052e3);const n=this.visualRadius,s=new Mn().load(Sn("/textures/venus.jpg"),h=>{h.colorSpace=$e,h.anisotropy=4}),o=new ht(n,Kc,Kc),a=o.attributes.position,l=new C,c=n*.015;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const u=l.x/n,f=l.y/n,g=l.z/n,_=Fr(u*6+50,f*6+100,g*6+150,4),m=Fr(u*15+200,f*15+300,g*15+400,3),p=_*.6+m*.4;let v=0;p>.35?v=((p-.35)/.65)**2*c:v=-(.35-p)/.35*c*.05,l.setLength(n+v),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,o.computeVertexNormals();const d=new gt({map:s,roughness:.9,metalness:0,color:16777215});this.mesh=new _e(o,d),this.mesh.position.set(e[0]*na,e[1]*na,e[2]*na),this.atmosphereGlow=new Hi(n,15247436,.4),this.mesh.add(this.atmosphereGlow.getMesh())}}const ia=On*kn,Zc=64;class Jv extends Hn{atmosphereGlow;constructor(e,t){super("earth",av,e,t,6371e3);const n=this.visualRadius,i=new ht(n,Zc,Zc),s=new gt({color:16777215,roughness:.7,metalness:0});this.mesh=new _e(i,s),this.mesh.position.set(e[0]*ia,e[1]*ia,e[2]*ia),this.atmosphereGlow=new Hi(n,4491519,.7),this.mesh.add(this.atmosphereGlow.getMesh()),this.generateTerrain(n),this.loadTexture()}getTerrainHeightVisual(e,t,n){const i=(Math.sin(e*4.5)*.5+Math.cos(t*3.2)*.3+Math.sin(n*2.1+e*1.5)*.2+Math.sin(e*8.1+t*3.7)*.15)*.4+.5,s=this.visualRadius*.015,o=this.visualRadius*.005;return i>.4?((i-.4)/.6)**2*s:-(.4-i)/.4*o}generateTerrain(e){const t=this.mesh.geometry,n=t.attributes.position,i=new C;for(let s=0;s<n.count;s++){i.fromBufferAttribute(n,s);const o=i.x/e,a=i.y/e,l=i.z/e,c=this.getTerrainHeightVisual(o,a,l);i.setLength(e+c),n.setXYZ(s,i.x,i.y,i.z)}n.needsUpdate=!0,t.computeVertexNormals()}async loadTexture(){const e=new Mn,[t]=await Promise.all([e.loadAsync(Sn("/textures/earth_daymap.jpg"))]);t.colorSpace=$e,t.anisotropy=8;const n=this.mesh.material;n.map=t,n.needsUpdate=!0;const i=new ht(this.visualRadius*.998,48,24),s=new gt({color:665672,transparent:!0,opacity:.06,roughness:.1,metalness:0});this.mesh.add(new _e(i,s)),this.addClouds(this.visualRadius)}addClouds(e){const t=new ht(e*1.008,48,24),n=new gt({color:16777215,transparent:!0,opacity:.25,roughness:.9,metalness:0,depthWrite:!1}),i=new _e(t,n),s=t.attributes.position;for(let o=0;o<s.count;o++){const a=s.getX(o),l=s.getY(o),c=s.getZ(o),h=((Math.sin(a*3.7+l*2.1)*.3+Math.cos(l*4.3+c*1.8)*.3+Math.sin(c*5.1+a*2.9)*.2+Math.sin(a*8.3+l*6.7+c*4.1)*.15)*.5+.5)*e*.006,u=Math.sqrt(a*a+l*l+c*c);s.setXYZ(o,a/u*(e*1.008+h),l/u*(e*1.008+h),c/u*(e*1.008+h))}s.needsUpdate=!0,t.computeVertexNormals(),this.mesh.add(i)}}const sa=On*kn,Jc=64,Kn=(r,e,t)=>{const n=Math.sin(r*127.1+e*311.7+t*74.9)*43758.5453;return n-Math.floor(n)},Qv=(r,e,t)=>{const n=Math.floor(r),i=Math.floor(e),s=Math.floor(t),o=r-n,a=e-i,l=t-s,c=o*o*(3-2*o),d=a*a*(3-2*a),h=l*l*(3-2*l),u=Kn(n,i,s),f=Kn(n+1,i,s),g=Kn(n,i+1,s),_=Kn(n+1,i+1,s),m=Kn(n,i,s+1),p=Kn(n+1,i,s+1),v=Kn(n,i+1,s+1),x=Kn(n+1,i+1,s+1);return yi(yi(yi(u,f,c),yi(g,_,c),d),yi(yi(m,p,c),yi(v,x,c),d),h)},Or=(r,e,t,n)=>{let i=0,s=1,o=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*Qv(r*l,e*l,t*l),o+=s,s*=.5}return i/o},yi=(r,e,t)=>r+(e-r)*t;class ex extends Hn{getTerrainHeightVisual(e,t,n){const i=Or(e*8+100,t*8+200,n*8+300,4),s=Or(e*30+400,t*30+500,n*30+600,3),o=i*.7+s*.3,a=this.visualRadius*.04;return o>.45?((o-.45)/.55)**2*a:-(.45-o)/.45*a*.15}constructor(e,t){super("moon",22e22,e,t,1737e3);const n=this.visualRadius,s=new Mn().load(Sn("/textures/moon.jpg"),h=>{h.colorSpace=$e,h.anisotropy=4}),o=new ht(n,Jc,Jc),a=o.attributes.position,l=new C,c=n*.04;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const u=l.x/n,f=l.y/n,g=l.z/n,_=Or(u*8+100,f*8+200,g*8+300,4),m=Or(u*30+400,f*30+500,g*30+600,3),p=_*.7+m*.3;let v=0;p>.45?v=((p-.45)/.55)**2*c:v=-(.45-p)/.45*c*.15,l.setLength(n+v),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,o.computeVertexNormals();const d=new gt({map:s,roughness:.95,metalness:0,color:16777215});this.mesh=new _e(o,d),this.mesh.position.set(e[0]*sa,e[1]*sa,e[2]*sa)}}const ra=On*kn,Qc=64,Zn=(r,e,t)=>{const n=Math.sin(r*127.1+e*311.7+t*74.9)*43758.5453;return n-Math.floor(n)},tx=(r,e,t)=>{const n=Math.floor(r),i=Math.floor(e),s=Math.floor(t),o=r-n,a=e-i,l=t-s,c=o*o*(3-2*o),d=a*a*(3-2*a),h=l*l*(3-2*l),u=Zn(n,i,s),f=Zn(n+1,i,s),g=Zn(n,i+1,s),_=Zn(n+1,i+1,s),m=Zn(n,i,s+1),p=Zn(n+1,i,s+1),v=Zn(n,i+1,s+1),x=Zn(n+1,i+1,s+1);return Mi(Mi(Mi(u,f,c),Mi(g,_,c),d),Mi(Mi(m,p,c),Mi(v,x,c),d),h)},kr=(r,e,t,n)=>{let i=0,s=1,o=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*tx(r*l,e*l,t*l),o+=s,s*=.5}return i/o},Mi=(r,e,t)=>r+(e-r)*t;class nx extends Hn{getTerrainHeightVisual(e,t,n){const i=kr(e*4+10,t*4+20,n*4+30,5),s=kr(e*20+100,t*20+200,n*20+300,3),o=i*.7+s*.3,a=this.visualRadius*.035;return o>.4?((o-.4)/.6)**2*a:-(.4-o)/.4*a*.1}atmosphereGlow;constructor(e,t){super("mars",19e23,e,t,339e4);const n=this.visualRadius,s=new Mn().load(Sn("/textures/mars.jpg"),h=>{h.colorSpace=$e,h.anisotropy=4}),o=new ht(n,Qc,Qc),a=o.attributes.position,l=new C,c=n*.035;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const u=l.x/n,f=l.y/n,g=l.z/n,_=kr(u*4+10,f*4+20,g*4+30,5),m=kr(u*20+100,f*20+200,g*20+300,3),p=_*.7+m*.3;let v=0;p>.4?v=((p-.4)/.6)**2*c:v=-(.4-p)/.4*c*.1,l.setLength(n+v),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,o.computeVertexNormals();const d=new gt({map:s,roughness:.85,metalness:0,color:16777215});this.mesh=new _e(o,d),this.mesh.position.set(e[0]*ra,e[1]*ra,e[2]*ra),this.atmosphereGlow=new Hi(n,13920842,.25),this.mesh.add(this.atmosphereGlow.getMesh())}}const eh=64,Jn=(r,e,t)=>{const n=Math.sin(r*127.1+e*311.7+t*74.9)*43758.5453;return n-Math.floor(n)},ix=(r,e,t)=>{const n=Math.floor(r),i=Math.floor(e),s=Math.floor(t),o=r-n,a=e-i,l=t-s,c=o*o*(3-2*o),d=a*a*(3-2*a),h=l*l*(3-2*l),u=Jn(n,i,s),f=Jn(n+1,i,s),g=Jn(n,i+1,s),_=Jn(n+1,i+1,s),m=Jn(n,i,s+1),p=Jn(n+1,i,s+1),v=Jn(n,i+1,s+1),x=Jn(n+1,i+1,s+1);return Si(Si(Si(u,f,c),Si(g,_,c),d),Si(Si(m,p,c),Si(v,x,c),d),h)},th=(r,e,t,n)=>{let i=0,s=1,o=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*ix(r*l,e*l,t*l),o+=s,s*=.5}return i/o},Si=(r,e,t)=>r+(e-r)*t;class sx extends Hn{atmosphereGlow;constructor(e,t){super("jupiter",19e26,e,t,69911e3);const n=this.visualRadius;new Mn().load(Sn("/textures/jupiter.jpg"),d=>{d.colorSpace=$e,d.anisotropy=4});const s=new ht(n,eh,eh),o=s.attributes.position,a=new C,l=n*.02;for(let d=0;d<o.count;d++){a.fromBufferAttribute(o,d);const h=a.x/n,u=a.y/n,f=a.z/n,g=th(h*8+10,u*8+20,f*8+30,4),_=th(h*30+100,u*30+200,f*30+300,3),m=g*.7+_*.3;let p=0;m>.4?p=((m-.4)/.6)**2*l:p=-(.4-m)/.4*l*.1,a.setLength(n+p),o.setXYZ(d,a.x,a.y,a.z)}o.needsUpdate=!0,s.computeVertexNormals();const c=new gt({map:void 0,roughness:.9,metalness:0,color:13935988});this.mesh=new _e(s,c),this.mesh.position.set(0,0,0),this.mesh.rotation.z=3.1*Math.PI/180,this.atmosphereGlow=new Hi(n,13935988,.15),this.mesh.add(this.atmosphereGlow.getMesh())}}function Qn(r,e,t){const n=Math.sin(r*127.1+e*311.7+t*74.9)*43758.5453;return n-Math.floor(n)}function rx(r,e,t){const n=Math.floor(r),i=Math.floor(e),s=Math.floor(t),o=r-n,a=e-i,l=t-s,c=o*o*(3-2*o),d=a*a*(3-2*a),h=l*l*(3-2*l),u=Qn(n,i,s),f=Qn(n+1,i,s),g=Qn(n,i+1,s),_=Qn(n+1,i+1,s),m=Qn(n,i,s+1),p=Qn(n+1,i,s+1),v=Qn(n,i+1,s+1),x=Qn(n+1,i+1,s+1);return bi(bi(bi(u,f,c),bi(g,_,c),d),bi(bi(m,p,c),bi(v,x,c),d),h)}function bs(r,e,t,n){let i=0,s=1,o=0;for(let a=0;a<n;a++){const l=1<<a;i+=s*rx(r*l,e*l,t*l),o+=s,s*=.5}return i/o}function bi(r,e,t){return r+(e-r)*t}function ox(){const t=document.createElement("canvas");t.width=1024,t.height=64;const n=t.getContext("2d"),i=n.createLinearGradient(0,0,1024,0);i.addColorStop(0,"#8a7a5a"),i.addColorStop(.05,"#b8a888"),i.addColorStop(.12,"#d4c8a8"),i.addColorStop(.2,"#c0b898"),i.addColorStop(.35,"#e8ddd0"),i.addColorStop(.5,"#c0b090"),i.addColorStop(.65,"#d8ccb0"),i.addColorStop(.8,"#a89878"),i.addColorStop(.9,"#786858"),i.addColorStop(1,"#584838"),n.fillStyle=i,n.fillRect(0,0,1024,64);for(let o=0;o<8e3;o++){const a=Math.random()*1024,l=Math.random()*64,c=1+Math.random()*4,d=120+Math.random()*80;n.fillStyle=`rgba(${d},${d-20},${d-40},${.2+Math.random()*.4})`,n.beginPath(),n.arc(a,l,c,0,Math.PI*2),n.fill()}n.fillStyle="rgba(0,0,0,0.7)",n.fillRect(1024*.43,0,1024*.04,64),n.fillStyle="rgba(0,0,0,0.4)",n.fillRect(1024*.72,0,1024*.015,64),n.fillStyle="rgba(0,0,0,0.3)",n.fillRect(1024*.1,0,1024*.02,64),n.fillRect(1024*.17,0,1024*.01,64),n.fillRect(1024*.55,0,1024*.02,64),n.fillStyle="rgba(200,190,170,0.15)";for(let o=0;o<1024;o+=8)n.fillRect(o,0,2,64);const s=new gn(t);return s.wrapS=qt,s.wrapT=qt,s.anisotropy=4,s}class ax extends Hn{atmosphereGlow;constructor(e,t){super("saturn",5683e23,e,t,58232e3);const n=this.visualRadius,s=new Mn().load(Sn("/textures/saturn.jpg"),v=>{v.colorSpace=$e,v.anisotropy=4}),o=new ht(n,64,32),a=o.attributes.position,l=new C,c=n*.015;for(let v=0;v<a.count;v++){l.fromBufferAttribute(a,v);const x=l.x/n,S=l.y/n,E=l.z/n,w=bs(x*8+10,S*8+20,E*8+30,4),R=bs(x*30+100,S*30+200,E*30+300,3),O=w*.7+R*.3;let M=0;O>.4?M=((O-.4)/.6)**2*c:M=-(.4-O)/.4*c*.1,l.setLength(n+M),a.setXYZ(v,l.x,l.y,l.z)}a.needsUpdate=!0,o.computeVertexNormals();const d=new gt({map:s,roughness:.9,metalness:0,color:16049313});this.mesh=new _e(o,d),this.mesh.position.set(0,0,0),this.mesh.rotation.z=26.7*Math.PI/180,this.atmosphereGlow=new Hi(n,16049313,.1),this.mesh.add(this.atmosphereGlow.getMesh());const h=ox(),u=new Ni(n*1.15,n*2.4,256),f=new It({map:h,side:Ht,transparent:!0,opacity:.8,depthWrite:!1}),g=new _e(u,f);g.rotation.x=-Math.PI/2,g.rotation.z=26.7*Math.PI/180,this.mesh.add(g);const _=new Ni(n*2.4,n*2.8,128),m=new It({color:8943720,side:Ht,transparent:!0,opacity:.15,depthWrite:!1}),p=new _e(_,m);p.rotation.x=-Math.PI/2,p.rotation.z=26.7*Math.PI/180,this.mesh.add(p)}}class lx extends Hn{atmosphereGlow;constructor(e,t){super("uranus",8681e22,e,t,25362e3);const n=this.visualRadius,s=new Mn().load(Sn("/textures/uranus.jpg"),g=>{g.colorSpace=$e,g.anisotropy=4}),o=new ht(n,64,32),a=o.attributes.position,l=new C,c=n*.015;for(let g=0;g<a.count;g++){l.fromBufferAttribute(a,g);const _=l.x/n,m=l.y/n,p=l.z/n,v=bs(_*6+10,m*6+20,p*6+30,4),x=bs(_*25+400,m*25+500,p*25+600,3),S=v*.7+x*.3;let E=0;S>.4?E=((S-.4)/.6)**2*c:E=-(.4-S)/.4*c*.1,l.setLength(n+E),a.setXYZ(g,l.x,l.y,l.z)}a.needsUpdate=!0,o.computeVertexNormals();const d=new gt({map:s,roughness:.9,metalness:0,color:5230824});this.mesh=new _e(o,d),this.mesh.position.set(0,0,0),this.mesh.rotation.z=-97.8*Math.PI/180,this.atmosphereGlow=new Hi(n,5230824,.1),this.mesh.add(this.atmosphereGlow.getMesh());const h=new Ni(n*1.2,n*2.1,64),u=new It({color:11184844,side:Ht,transparent:!0,opacity:.3}),f=new _e(h,u);f.rotation.x=-Math.PI/2,f.rotation.z=97.8*Math.PI/180,this.mesh.add(f)}}class cx extends Hn{atmosphereGlow;constructor(e,t){super("neptune",1024e23,e,t,24622e3);const n=this.visualRadius,s=new Mn().load(Sn("/textures/neptune.jpg"),h=>{h.colorSpace=$e,h.anisotropy=4}),o=new ht(n,64,32),a=o.attributes.position,l=new C,c=n*.015;for(let h=0;h<a.count;h++){l.fromBufferAttribute(a,h);const u=l.x/n,f=l.y/n,g=l.z/n,_=bs(u*6+10,f*6+20,g*6+30,4),m=bs(u*25+100,f*25+200,g*25+300,3),p=_*.7+m*.3;let v=0;p>.4?v=((p-.4)/.6)**2*c:v=-(.4-p)/.4*c*.1,l.setLength(n+v),a.setXYZ(h,l.x,l.y,l.z)}a.needsUpdate=!0,o.computeVertexNormals();const d=new gt({map:s,roughness:.9,metalness:0,color:4944093});this.mesh=new _e(o,d),this.mesh.position.set(0,0,0),this.mesh.rotation.z=28.3*Math.PI/180,this.atmosphereGlow=new Hi(n,4944093,.15),this.mesh.add(this.atmosphereGlow.getMesh())}}const cs=On*kn,hx=`
varying vec2 vUv;
void main() {
  vUv = uv;
...
`;class dx extends za{light;visualRadius;mesh;constructor(e,t,n=2e26){super("sun",n,e,t),this.visualRadius=15;const i=new ht(this.visualRadius,32,16),s=new vn({vertexShader:hx,fragmentShader:ux,uniforms:{uTime:{value:0},uColor:{value:new Te(16763904)},uIntensity:{value:1.5}},transparent:!0,blending:Nn,depthWrite:!1,side:Ht});this.mesh=new _e(i,s),this.mesh.position.set(e[0]*cs,e[1]*cs,e[2]*cs),this.light=new js(16772829,2.5),this.light.position.set(this.mesh.position.x+100,this.mesh.position.y+50,this.mesh.position.z);const o=fx(),a=new Da({map:o,blending:Nn,depthWrite:!1,transparent:!0,opacity:1}),l=new Gh(a);l.scale.set(200,200,1),this.mesh.add(l),this.sunMaterial=s}sunMaterial;update(e){this.sunMaterial.uniforms.uTime.value+=e}syncMesh(){this.mesh.position.set(this.position[0]*cs,this.position[1]*cs,this.position[2]*cs),this.light.position.set(this.mesh.position.x+100,this.mesh.position.y+50,this.mesh.position.z)}}function fx(){const e=document.createElement("canvas");e.width=256,e.height=256;const t=e.getContext("2d"),n=t.createRadialGradient(256/2,256/2,0,256/2,256/2,256/2);n.addColorStop(0,"rgba(255, 220, 100, 1)"),n.addColorStop(.1,"rgba(255, 200, 80, 0.8)"),n.addColorStop(.3,"rgba(255, 160, 40, 0.4)"),n.addColorStop(.5,"rgba(255, 100, 20, 0.15)"),n.addColorStop(.7,"rgba(255, 60, 10, 0.05)"),n.addColorStop(1,"rgba(255, 0, 0, 0)"),t.fillStyle=n,t.fillRect(0,0,256,256);const i=new gn(e);return i.needsUpdate=!0,i}class nh{assembly;fuelTanks;constructor(e){this.assembly=e,this.fuelTanks=[],ru(e.roots,this.fuelTanks)}dryMass(){return this.assembly.totalMass()}totalFuelMass(){return this.fuelTanks.reduce((e,t)=>e+t.remaining,0)}totalMass(){return this.dryMass()+this.totalFuelMass()}consumeFuel(e,t){let n=0;for(let i=this.fuelTanks.length-1;i>=0;i--){const s=this.fuelTanks[i];if(s.remaining<=0)continue;const o=e*t-n;if(o<=0)break;const a=Math.min(s.remaining,o);s.remaining-=a,n+=a}return n}removeStage(e){const t=new Set;ou(e,t),t.add(e),this.fuelTanks=this.fuelTanks.filter(n=>!t.has(n.node)),e.children=[]}}function ru(r,e){for(const t of r)t.part.fuelCapacity&&e.push({node:t,remaining:t.part.fuelCapacity,capacity:t.part.fuelCapacity}),ru(t.children,e)}function ou(r,e){for(const t of r.children)e.add(t),ou(t,e)}const ih="ellipse_achievements";class px{unlocked=new Set;callbacks=[];constructor(){const e=localStorage.getItem(ih);if(e)try{JSON.parse(e).forEach(t=>this.unlocked.add(t))}catch{}}unlock(e){this.unlocked.has(e)||(this.unlocked.add(e),localStorage.setItem(ih,JSON.stringify([...this.unlocked])),this.callbacks.forEach(t=>t(e)))}isUnlocked(e){return this.unlocked.has(e)}list(){return[...this.unlocked]}onUnlock(e){this.callbacks.push(e)}}const oa={units:"metric",autoSave:!0,difficulty:"normal"},au="ellipse_settings";function mx(){const r=localStorage.getItem(au);if(!r)return{...oa};try{return{...oa,...JSON.parse(r)}}catch{return{...oa}}}function sh(r){localStorage.setItem(au,JSON.stringify(r))}class gx{root;onClose;current;constructor(e,t){this.current=e,this.onClose=t,this.root=document.createElement("div"),this.root.style.cssText=`
      position: fixed; inset: 0; z-index: 250;
      background: rgba(6, 8, 20, 0.88);
      display: flex; align-items: center; justify-content: center;
    `;const n=document.createElement("div");n.className="panel panel--elevated",n.style.cssText="padding: var(--space-6); min-width: 400px;";const i=document.createElement("h2");i.className="text-display-sm",i.textContent="Settings",i.style.cssText="margin: 0 0 var(--space-5);",n.appendChild(i);const s=this.makeRow("Units",["metric","imperial","mixed"],e.units,l=>{this.current.units=l});n.appendChild(s);const o=this.makeToggle("Auto-save",e.autoSave,l=>{this.current.autoSave=l});n.appendChild(o);const a=document.createElement("button");a.className="btn btn--primary",a.textContent="Save & Close",a.style.cssText="margin-top: var(--space-4); width: 100%; padding: 12px;",a.addEventListener("click",()=>{sh(this.current),this.onClose()}),n.appendChild(a),this.root.appendChild(n)}makeRow(e,t,n,i){const s=document.createElement("div");s.style.cssText="margin: var(--space-3) 0;";const o=document.createElement("div");o.className="text-caption",o.textContent=e,o.style.cssText="margin-bottom: var(--space-2);",s.appendChild(o);const a=document.createElement("div");a.style.cssText="display:flex;gap:var(--space-2);";for(const l of t){const c=document.createElement("button");c.className=`btn${l===n?" btn--secondary":""}`,c.textContent=l,l===n&&(c.style.borderColor="var(--accent-blue)"),c.addEventListener("click",()=>{i(l),sh(this.current)}),a.appendChild(c)}return s.appendChild(a),s}makeToggle(e,t,n){const i=document.createElement("div");i.style.cssText="margin: var(--space-3) 0; display: flex; justify-content: space-between; align-items: center;";const s=document.createElement("span");s.className="text-body",s.textContent=e;const o=document.createElement("input");return o.type="checkbox",o.checked=t,o.addEventListener("change",()=>n(o.checked)),i.appendChild(s),i.appendChild(o),i}mount(e=document.body){e.appendChild(this.root)}unmount(){this.root.remove()}}function Hr(r){const e=document.createElement("canvas");e.width=64,e.height=64;const t=e.getContext("2d");t.fillStyle=r,t.fillRect(0,0,64,64),t.strokeStyle="#000",t.lineWidth=2,t.strokeRect(0,0,64,64),t.strokeRect(16,16,32,32);const n=new gn(e);return n.wrapS=n.wrapT=Jt,n.repeat.set(2,1),n.anisotropy=4,n.needsUpdate=!0,n}Hr("#8899aa"),Hr("#808080"),Hr("#808080"),Hr("#000000");async function Ri(r,e=$e){const t=await new Promise((i,s)=>{const o=new Image;o.onload=()=>i(o),o.onerror=()=>s(new Error(`Failed: ${r}`)),o.src=r}),n=new Mt(t);return n.colorSpace=e,n.wrapS=n.wrapT=Jt,n.repeat.set(2,1),n.anisotropy=4,n.needsUpdate=!0,n}async function Br(r){const[e,t,n,i]=await Promise.all([Ri(`/textures/${r}_color.jpg`,$e),Ri(`/textures/${r}_normal.jpg`,ft),Ri(`/textures/${r}_rough.jpg`,ft),Ri(`/textures/${r}_metal.jpg`,ft)]);return{color:e,normal:t,roughness:n,metalness:i}}let _x=!1,vx=null,xx=null,yx=null,Mx=null,Sx=null,zr=null;function bx(){return zr||(zr=(async()=>{try{[vx,xx,yx,Mx,Sx]=await Promise.all([Br("metal013"),Br("plates"),Br("metal009"),Br("metal021"),(async()=>{const[r,e,t]=await Promise.all([Ri("/textures/fabric_color.jpg",$e),Ri("/textures/fabric_normal.jpg",ft),Ri("/textures/fabric_rough.jpg",ft)]);return{color:r,normal:e,roughness:t,metalness:t}})()]),_x=!0}catch(r){console.error("Texture loading failed, using fallback",r)}})(),zr)}class Tx{renderer;sceneMgr;system;achievements;mainMenu;vab;flight;constructor(){bx(),this.renderer=new y_,this.sceneMgr=new T_,this.achievements=new px,this.system=new Vv;const e=2e26;this.system.add(new dx([0,0,0],[0,0,0],e)),this.system.add(new qv([15e7,0,2e7],[0,0,47400])),this.system.add(new Zv([3e8,0,-3e7],[0,0,3e4]));const t=[5e8,0,0],n=[0,0,24e3];this.system.add(new Jv(t,n));const i=[t[0],0,t[2]+3844e5],s=[0,0,n[2]+1020];this.system.add(new ex(i,s)),this.system.add(new nx([75e7,5e8,-2e8],[0,0,19500])),this.system.add(new sx([15e8,-3e8,1e8],[0,0,13e3])),this.system.add(new ax([28e8,2e8,-2e8],[0,0,9700])),this.system.add(new lx([55e8,-1e8,3e8],[0,0,6800])),this.system.add(new cx([85e8,4e8,0],[0,0,5400])),document.getElementById("app").appendChild(this.renderer.domElement),this.renderer.setSize(window.innerWidth,window.innerHeight),window.addEventListener("resize",()=>{this.renderer.setSize(window.innerWidth,window.innerHeight),this.sceneMgr.camera.aspect=window.innerWidth/window.innerHeight,this.sceneMgr.camera.updateProjectionMatrix()}),this.achievements.onUnlock(o=>In.show(`Achievement: ${o}`)),this.preloadModels()}async preloadModels(){const{loadGLTF:e}=await rh(async()=>{const{loadGLTF:t}=await Promise.resolve().then(()=>iu);return{loadGLTF:t}},void 0);await e("/models/agena.glb",1)}start(){this.showMainMenu(),this.loop()}showMainMenu(){this.unmountCurrent(),this.mainMenu=new E_(()=>this.showFlight(),()=>this.showVab(),()=>this.showSettings()),this.mainMenu.mount()}showSettings(){const e=new gx(mx(),()=>e.unmount());e.mount()}showVab(){this.unmountCurrent(),this.vab=new Cv(e=>{const t=new nh(e);this.showFlight(t)}),this.vab.mount(),this.sceneMgr.scene.add(this.vab.scene)}async showFlight(e){this.unmountCurrent();const t=e?.assembly??new eo;if(!e){const i=Ke;t.addRoot({part:Vr("capsule_mk1"),position:[0,1.6*i,0],rotation:0,children:[]}),t.addRoot({part:Vr("tank_s_lfo"),position:[0,.8*i,0],rotation:0,children:[]}),t.addRoot({part:Vr("engine_ant"),position:[0,0,0],rotation:0,children:[]})}const n=new nh(t);this.flight=new Gv(this.renderer,this.sceneMgr,this.system,n,this.achievements)}unmountCurrent(){this.mainMenu?.unmount(),this.mainMenu=void 0,this.vab&&(this.vab.unmount(),this.sceneMgr.scene.remove(this.vab.scene),this.vab=void 0),this.flight?.dispose(),this.flight=void 0}loop(){const e=.016666666666666666;this.sceneMgr.update(e),this.flight?.update(e),this.vab?this.renderer.three.render(this.vab.scene,this.vab.camera):this.renderer.three.render(this.sceneMgr.scene,this.sceneMgr.camera),requestAnimationFrame(()=>this.loop())}}try{new Tx().start()}catch(r){console.error("Failed to start StarWeld:",r),document.body.innerHTML=`<div style="color:white;padding:32px;font-family:monospace;">
      <h1>StarWeld failed to start</h1>
      <pre>${String(r)}</pre>
    </div>`}
//# sourceMappingURL=index-BwhXb4jZ.js.map
