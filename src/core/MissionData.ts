...
export const MISSIONS: MissionDef[] = [
  ...
  { id: 'reach_space',    name: 'Edge of Space',        description: 'Reach 100 km altitude',            reward: 25,  category: 'altitude' },
  ...
  { id: 'ev_astronaut',   name: 'EV Astronaut',         description: 'Exceed 7000 m/s',       reward: 35,  category: 'speed' },
