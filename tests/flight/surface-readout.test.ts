...
it('shows readable surface clearance while descending and hides on the pad',()=>{
 expect(surfaceReadout(42,-3,false)).toMatchObject({visible:true,height:'42 m',descent:'↓ 3.0 m/s',near:true});
 expect(surfaceReadout(1200,-50,false).height).toBe('1.2 km');
